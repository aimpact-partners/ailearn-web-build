System.register(["@beyond-js/widgets@1.1.0/render", "@beyond-js/kernel@0.1.9/bundle", "@beyond-js/kernel@0.1.9/styles", "@beyond-js/react-18-widgets@1.1.2/page", "@aimpact/ailearn-app@0.1.6-dev.10/main-layout.widget", "@aimpact/chat-sdk@1.1.0/session", "@beyond-js/reactive@1.2.0/model", "@beyond-js/kernel@0.1.9/texts", "@aimpact/ailearn-sdk@1.0.0/learning-modules", "@aimpact/ailearn-sdk@1.0.0/core", "react@18.2.0", "@aimpact/ailearn-app@0.1.6-dev.10/components/icons", "pragmate-ui@1.0.0-beta.2/components", "pragmate-ui@1.0.0-beta.2/list", "@aimpact/ailearn-app@0.1.6-dev.10/components/ui", "@aimpact/ailearn-app@0.1.6-dev.10/components/module-card", "@aimpact/ailearn-app@0.1.6-dev.10/modules/owner-assign.code", "pragmate-ui@1.0.0-beta.2/modal", "pragmate-ui@1.0.0-beta.2/icons", "@beyond-js/kernel@0.1.9/routing", "@beyond-js/react-18-widgets@1.1.2/hooks", "@aimpact/ailearn-app@0.1.6-dev.10/modules/assign", "pragmate-ui@1.0.0-beta.2/image", "pragmate-ui@1.0.0-beta.2/swiper"], function (_export, _context2) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsWidgets110Render) {
      ...
      dependency_11 = _aimpactAilearnApp016Dev10ComponentsIcons;
      ...
      dependency_15 = _aimpactAilearnApp016Dev10ComponentsModuleCard;
    }, function (_aimpactAilearnApp016Dev10ModulesOwnerAssignCode) {
      dependency_16 = _aimpactAilearnApp016Dev10ModulesOwnerAssignCode;
    ...
    }, function (_aimpactAilearnApp016Dev10ModulesAssign) {
      dependency_21 = _aimpactAilearnApp016Dev10ModulesAssign;
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.10/home",
          "multibundle": true
        },
        "type": "widget"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.1.6-dev.10/home.widget');
      ims = new Map();
      /****************************
