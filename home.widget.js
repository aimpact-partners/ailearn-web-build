System.register(
	[
		'@beyond-js/widgets@1.1.0/render',
		'@beyond-js/kernel@0.1.9/bundle',
		'@beyond-js/kernel@0.1.9/styles',
		'@beyond-js/react-18-widgets@1.1.2/page',
		'@aimpact/ailearn-app@0.0.57/main-layout.widget',
		'@aimpact/chat-sdk@1.0.1/session',
		'@beyond-js/reactive@1.1.12/model',
		'@beyond-js/kernel@0.1.9/texts',
		'react@18.2.0',
		'@aimpact/ailearn-app@0.0.57/components/ui',
		'pragmate-ui@0.1.1/components',
		'pragmate-ui@0.1.1/list',
		'pragmate-ui@0.1.1/link',
		'swiper@8.4.7',
		'@beyond-js/react-18-widgets@1.1.2/hooks',
		'@aimpact/ailearn-app@0.0.57/modules/assign',
		'pragmate-ui@0.1.1/image',
	],
	function (_export, _context2) {
		...
		return {
			setters: [
				...
				function (_aimpactAilearnApp0057ModulesAssign) {
					dependency_15 = _aimpactAilearnApp0057ModulesAssign;
				},
			...
			execute: function () {
				bimport = specifier => {
					const dependencies = new Map([
						...
						['@aimpact/chat', '1.0.2'],
						['@aimpact/auth', '0.0.1'],
						['@aimpact/chat-sdk', '1.0.1'],
						['@aimpact/media-manager', '1.0.0'],
						['@beyond-js/reactive', '1.1.12'],
						['pragmate-ui', '0.1.1'],
						['@aimpact/http-suite', '0.0.1'],
						['@beyond-js/widgets', '1.1.0'],
						['@beyond-js/events', '0.0.4'],
				...
				__pkg = new __Bundle(
					{
						module: {
							vspecifier: '@aimpact/ailearn-app@0.0.57/home',
							multibundle: true,
						},
						type: 'widget',
					},
				...
				__pkg.dependencies.update([
					...
					['@aimpact/ailearn-app/main-layout.widget', dependency_4],
					['@aimpact/chat-sdk/session', dependency_5],
					['@beyond-js/reactive/model', dependency_6],
					['@beyond-js/kernel/texts', dependency_7],
					['react', dependency_8],
					['@aimpact/ailearn-app/components/ui', dependency_9],
					['pragmate-ui/components', dependency_10],
					['pragmate-ui/list', dependency_11],
					['pragmate-ui/link', dependency_12],
					['swiper', dependency_13],
					['@beyond-js/react-18-widgets/hooks', dependency_14],
					['@aimpact/ailearn-app/modules/assign', dependency_15],
					['pragmate-ui/image', dependency_16],
				]);
				...
				brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.0.57/home.widget');
				ims = new Map();
				/****************************
						...
						class StoreManager extends _model.ReactiveModel {
							...
							async load() {
								try {
									...
									this.setBreadcrumb();
									const { status, data } = await this.#model.user.getHome();
									if (!status) {
										console.log('error');
									}
						...
						function AsideClassrooms() {
							...
							return _react.default.createElement(
								...
								_react.default.createElement(
									...
									_react.default.createElement('h5', null, texts.title),
									_react.default.createElement(
										_components.Link,
										{
								...
								: drafts.map(draft => {
										const content =
											!draft.description || draft.description === ''
												...
												: draft.description;
										const title =
											!draft.title || draft.title === '' ? texts.items.title : draft.title;
										return _react.default.createElement(
											_components.Link,
											{
						...
						function Aside() {
							return _react.default.createElement(
								...
								_react.default.createElement(
									...
									_react.default.createElement(_drafts.AsideDrafts, null),
									_react.default.createElement(_classrooms.AsideClassrooms, null),
								),
							);
						}
					},
							...
							return _react.default.createElement(
								...
								_react.default.createElement(
									...
									_react.default.createElement(
										...
										_react.default.createElement('h4', null, module.title),
										_react.default.createElement('span', null, module.description),
									),
								),
								_react.default.createElement(
									'footer',
				...
				ims.set('./views/index', {
					...
					creator: function (require, exports) {
						...
						function View({ store }) {
							...
							return _react.default.createElement(
								_context.ModuleContext.Provider,
								{
									value: contextValue,
								},
								_react.default.createElement(
									...
									_react.default.createElement(
										...
										_react.default.createElement(
											'main',
											null,
											_react.default.createElement(_userCard.UserCard, null),
											_react.default.createElement(_assigments.Assignments, null),
											_react.default.createElement(_modules.Modules, null),
										),
      ...
      ***************************************/
				...
				ims.set('./views/modules/actions', {
					...
					creator: function (require, exports) {
						...
						var _context = require('../context');
						function LearningModuleActions({ module }) {
							const { texts } = (0, _context.useModuleContext)();
							...
							return React.createElement(
								...
								openModal &&
									React.createElement(_assign.ModuleAssignments, {
										module: module,
										onClose: toggleModal,
										texts: texts.assign,
									}),
							...
							return _react.default.createElement(
								...
								_react.default.createElement(
									...
									_react.default.createElement(
										...
										_react.default.createElement('h6', null, user.displayName),
										_react.default.createElement(
											'span',
											{
												className: 'p2',
							...
							return _react.default.createElement(
								...
								_react.default.createElement(
									...
									_react.default.createElement(
										...
										_react.default.createElement('h3', null, user.displayName),
										_react.default.createElement(
											'span',
											{
												className: 'p2',
      ...
      ******************************************/
				...
				__pkg.exports.process = function ({ require, prop, value }) {
					...
					(require || prop === 'AssignmentItem') &&
						_export(
							'AssignmentItem',
							(AssignmentItem = require ? require('./views/assigments/item').AssignmentItem : value),
						);
					(require || prop === 'View') &&
						_export('View', (View = require ? require('./views/index').View : value));
					(require || prop === 'ModuleItem') &&
						_export(
							'ModuleItem',
							(ModuleItem = require ? require('./views/modules/item').ModuleItem : value),
						);
					(require || prop === 'UserCard') &&
						_export('UserCard', (UserCard = require ? require('./views/sections/drafts').UserCard : value));
					(require || prop === 'UserCard') &&
						_export(
							'UserCard',
							(UserCard = require ? require('./views/sections/modules').UserCard : value),
						);
					(require || prop === 'UserCard') &&
						_export(
							'UserCard',
							(UserCard = require ? require('./views/sections/user-card').UserCard : value),
						);
				};
