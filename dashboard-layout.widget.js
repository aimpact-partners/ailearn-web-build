System.register(["@beyond-js/widgets@1.1.3/render", "@beyond-js/kernel@0.1.12/bundle", "@aimpact/reactive@0.0.1/model", "@aimpact/ailearn-app@0.3.32/widgets/breadcrumb.widget", "@beyond-js/react-18-widgets@1.1.4/base", "@aimpact/chat-sdk@1.4.3/core", "@aimpact/chat-sdk@1.4.3/wrapper", "react@18.3.1", "framer-motion@10.18.0", "@aimpact/ailearn-app@0.3.32/components/navbar-header.code", "@beyond-js/react-18-widgets@1.1.4/hooks", "pragmate-ui@1.0.0-beta.7/icons", "pragmate-ui@1.0.0-beta.7/toast", "@aimpact/ailearn-app@0.3.32/components/ui", "@beyond-js/kernel@0.1.12/styles"], function (_export, _context2) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsWidgets113Render) {
      ...
      dependency_6 = _aimpactChatSdk143Wrapper;
    }, function (_react2) {
      dependency_7 = _react2;
    }, function (_framerMotion2) {
      dependency_8 = _framerMotion2;
    }, function (_aimpactAilearnApp0332ComponentsNavbarHeaderCode) {
      dependency_9 = _aimpactAilearnApp0332ComponentsNavbarHeaderCode;
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.3.32/dashboard-layout",
          "multibundle": true
        },
        "type": "widget"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.3.32/dashboard-layout.widget');
      ims = new Map();
      /************************
