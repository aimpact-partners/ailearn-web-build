System.register(["@beyond-js/kernel@0.1.12/bundle", "@aimpact/ailearn-app@0.3.32/components/icons", "react@18.3.1", "pragmate-ui@1.0.0-beta.7/components", "pragmate-ui@1.0.0-beta.7/icons", "@aimpact/ailearn-app@0.3.32/main-layout.widget", "pragmate-ui@1.0.0-beta.7/image", "pragmate-ui@1.0.0-beta.7/modal", "pragmate-ui@1.0.0-beta.7/alert", "@aimpact/ailearn-app@0.3.32/components/ui", "@aimpact/ailearn-app@0.3.32/modules/management/refinament.code", "@beyond-js/react-18-widgets@1.1.4/hooks", "@beyond-js/kernel@0.1.12/styles"], function (_export, _context2) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsKernel0112Bundle) {
      ...
      dependency_1 = _aimpactAilearnApp0332ComponentsIcons;
    }, function (_react2) {
      ...
      dependency_10 = _aimpactAilearnApp0332ModulesManagementRefinamentCode;
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.3.32/components/cover-image",
          "multibundle": true
        },
        "type": "code"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.3.32/components/cover-image.code');
      ims = new Map();
      /*************************
