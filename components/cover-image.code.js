System.register(["@beyond-js/kernel@0.1.9/bundle", "@aimpact/ailearn-app@0.3.8/components/icons", "react@18.2.0", "pragmate-ui@1.0.0-beta.7/components", "pragmate-ui@1.0.0-beta.7/icons", "@aimpact/ailearn-app@0.3.8/main-layout.widget", "pragmate-ui@1.0.0-beta.7/image", "pragmate-ui@1.0.0-beta.7/modal", "pragmate-ui@1.0.0-beta.7/alert", "@aimpact/ailearn-app@0.3.8/components/ui", "@aimpact/ailearn-app@0.3.8/modules/management/refinament.code", "@beyond-js/react-18-widgets@1.1.3/hooks", "@beyond-js/kernel@0.1.9/styles"], function (_export, _context2) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsKernel019Bundle) {
      ...
      dependency_1 = _aimpactAilearnApp038ComponentsIcons;
    }, function (_react2) {
      ...
      dependency_5 = _aimpactAilearnApp038MainLayoutWidget;
      ...
      dependency_10 = _aimpactAilearnApp038ModulesManagementRefinamentCode;
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.3.8/components/cover-image",
          "multibundle": true
        },
        "type": "code"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.3.8/components/cover-image.code');
      ims = new Map();
      /*************************
