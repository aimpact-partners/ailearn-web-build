System.register(["@beyond-js/kernel@0.1.9/bundle", "react@18.2.0", "pragmate-ui@1.0.0-beta.1/icons", "@aimpact/ailearn-app@0.1.3-test.08/components/icons", "@aimpact/ailearn-app@0.1.3-test.08/main-layout.widget", "pragmate-ui@1.0.0-beta.1/components", "pragmate-ui@1.0.0-beta.1/modal", "pragmate-ui@1.0.0-beta.1/form", "pragmate-ui@1.0.0-beta.1/image", "pragmate-ui@1.0.0-beta.1/alert", "@aimpact/ailearn-app@0.1.3-test.08/components/ui", "@aimpact/chat@1.0.2/shared/hooks", "@beyond-js/kernel@0.1.9/styles"], function (_export, _context2) {
  ...
  return {
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.1.3-test.08/components/cover-image",
          "multibundle": true
        },
        "type": "code"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.1.3-test.08/components/cover-image.code');
      ims = new Map();
      /*************************
