System.register(["@beyond-js/kernel@0.1.9/bundle", "@beyond-js/kernel@0.1.9/styles", "react@18.2.0", "pragmate-ui@1.0.0-beta.2/components", "pragmate-ui@1.0.0-beta.2/list", "pragmate-ui@1.0.0-beta.2/icons"], function (_export, _context2) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsKernel019Bundle) {
      ...
      dependency_4 = _pragmateUi100Beta2List;
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.10/components/ui/bullet-points-input"
        },
        "type": "code"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.1.6-dev.10/components/ui/bullet-points-input');
      ims = new Map();
      /*************************
