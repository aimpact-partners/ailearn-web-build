System.register(["@beyond-js/kernel@0.1.9/bundle", "@beyond-js/kernel@0.1.9/styles", "react@18.2.0", "pragmate-ui@1.0.0-beta.1/list", "@aimpact/ailearn-app@0.1.3-test.04/components/icons", "@aimpact/ailearn-app@0.1.3-test.04/components/ui", "pragmate-ui@1.0.0-beta.1/components", "dayjs@1.11.10", "pragmate-ui@1.0.0-beta.1/image"], function (_export, _context) {
  ...
  return {
    setters: [function (_beyondJsKernel019Bundle) {
      ...
      dependency_4 = _aimpactAilearnApp013Test04ComponentsIcons;
    }, function (_aimpactAilearnApp013Test04ComponentsUi) {
      dependency_5 = _aimpactAilearnApp013Test04ComponentsUi;
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.1.3-test.04/components/module-card"
        },
        "type": "code"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.1.3-test.04/components/module-card');
      ims = new Map();
      /****************************
