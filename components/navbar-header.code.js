System.register(["@beyond-js/kernel@0.1.9/bundle", "@beyond-js/kernel@0.1.9/styles", "@beyond-js/kernel@0.1.9/routing", "pragmate-ui@1.0.0-beta.1/icons", "react@18.2.0", "@beyond-js/react-18-widgets@1.1.2/hooks", "pragmate-ui@1.0.0-beta.1/image", "pragmate-ui@1.0.0-beta.1/breadcrumb", "@aimpact/ailearn-app@0.1.0-dev.03/components/ui", "@aimpact/chat-sdk@1.0.1/session", "pragmate-ui@1.0.0-beta.1/components", "@aimpact/ailearn-app@0.1.0-dev.03/components/icons", "pragmate-ui@1.0.0-beta.1/dropdown", "@beyond-js/widgets@1.1.0/render"], function (_export, _context3) {
  ...
  return {
    setters: [function (_beyondJsKernel019Bundle) {
      ...
      dependency_11 = _aimpactAilearnApp010Dev03ComponentsIcons;
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.1.0-dev.03/components/navbar-header",
          "multibundle": true
        },
        "type": "code"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.1.0-dev.03/components/navbar-header.code');
      ims = new Map();
      /**************************
