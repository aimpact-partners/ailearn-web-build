System.register(["@beyond-js/kernel@0.1.9/bundle", "@beyond-js/kernel@0.1.9/styles", "@beyond-js/kernel@0.1.9/routing", "pragmate-ui@1.0.0-beta.2/icons", "react@18.2.0", "@beyond-js/react-18-widgets@1.1.2/hooks", "pragmate-ui@1.0.0-beta.2/image", "@aimpact/ailearn-app@0.1.6-dev.07/components/breadcrumb.code", "@aimpact/chat-sdk@1.1.0/session", "pragmate-ui@1.0.0-beta.2/components", "@aimpact/ailearn-app@0.1.6-dev.07/components/icons", "@aimpact/ailearn-app@0.1.6-dev.07/components/ui", "pragmate-ui@1.0.0-beta.2/dropdown", "@beyond-js/widgets@1.1.0/render"], function (_export, _context3) {
  ...
  return {
    ...
    }, function (_aimpactAilearnApp016Dev07ComponentsBreadcrumbCode) {
      dependency_7 = _aimpactAilearnApp016Dev07ComponentsBreadcrumbCode;
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.07/components/navbar-header",
          "multibundle": true
        },
        "type": "code"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.1.6-dev.07/components/navbar-header.code');
      ims = new Map();
      /**************************
