System.register(["@beyond-js/kernel@0.1.9/bundle", "@beyond-js/kernel@0.1.9/styles", "@beyond-js/kernel@0.1.9/routing", "pragmate-ui@1.0.0-beta.7/icons", "react@18.2.0", "@beyond-js/react-18-widgets@1.1.2/hooks", "pragmate-ui@1.0.0-beta.7/image", "@aimpact/chat-sdk@1.3.0/session", "pragmate-ui@1.0.0-beta.7/components", "@aimpact/ailearn-app@0.2.16/components/icons", "dayjs@1.11.13", "@aimpact/ailearn-app@0.2.16/components/hooks", "@aimpact/ailearn-app@0.2.16/components/ui", "pragmate-ui@1.0.0-beta.7/dropdown", "@beyond-js/widgets@1.1.1/render"], function (_export, _context3) {
  ...
  return {
    setters: [function (_beyondJsKernel019Bundle) {
      ...
      dependency_9 = _aimpactAilearnApp0216ComponentsIcons;
    }, function (_dayjs2) {
      dependency_10 = _dayjs2;
    }, function (_aimpactAilearnApp0216ComponentsHooks) {
      dependency_11 = _aimpactAilearnApp0216ComponentsHooks;
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.2.16/components/navbar-header",
          "multibundle": true
        },
        "type": "code"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.2.16/components/navbar-header.code');
      ims = new Map();
      /**************************
