System.register(["@beyond-js/widgets@1.1.2/render", "@beyond-js/kernel@0.1.12/bundle", "@aimpact/ailearn-app@0.3.32/assignments/chat", "@beyond-js/react-18-widgets@1.1.4/page", "@aimpact/ailearn-app@0.3.32/main-layout.widget", "@beyond-js/widgets@1.1.2/controller", "@aimpact/ailearn-app@0.3.32/entities/assignments/activities/base"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsWidgets112Render) {
      ...
      dependency_2 = _aimpactAilearnApp0332AssignmentsChat;
      ...
      dependency_6 = _aimpactAilearnApp0332EntitiesAssignmentsActivitiesBase;
    }],
    execute: function () {
      bimport = specifier => {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.3.32/assignments/character-talk",
          "multibundle": true
        },
        "type": "widget"
