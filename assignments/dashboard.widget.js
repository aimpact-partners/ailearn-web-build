System.register(["@beyond-js/widgets@1.1.0/render", "@beyond-js/kernel@0.1.9/bundle", "@beyond-js/kernel@0.1.9/styles", "@beyond-js/react-18-widgets@1.1.2/page", "@aimpact/ailearn-app@0.1.6-dev.34/dashboard-layout.widget", "@beyond-js/reactive@1.2.0/model", "@aimpact/http-suite@0.0.1/api", "@aimpact/ailearn-sdk@1.0.0/config", "@aimpact/chat-sdk@1.2.0/session", "@beyond-js/kernel@0.1.9/texts", "@aimpact/ailearn-sdk@1.0.0/core", "react@18.2.0", "@aimpact/ailearn-app@0.1.6-dev.34/components/ui", "@aimpact/ailearn-app@0.1.6-dev.34/components/navbar-header.code", "pragmate-ui@1.0.0-beta.6/icons", "@aimpact/ailearn-app@0.1.6-dev.34/config", "pragmate-ui@1.0.0-beta.6/empty", "@aimpact/ailearn-app@0.1.6-dev.34/shared/charts", "@aimpact/ailearn-app@0.1.6-dev.34/components/icons", "pragmate-ui@1.0.0-beta.6/components", "pragmate-ui@1.0.0-beta.6/list", "@beyond-js/react-18-widgets@1.1.2/hooks", "pragmate-ui@1.0.0-beta.6/chips", "pragmate-ui@1.0.0-beta.6/image", "@aimpact/ailearn-app@0.1.6-dev.34/utils", "pragmate-ui@1.0.0-beta.6/tooltip"], function (_export, _context2) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsWidgets110Render) {
      ...
      dependency_13 = _aimpactAilearnApp016Dev34ComponentsNavbarHeaderCode;
    ...
    }, function (_aimpactAilearnApp016Dev34SharedCharts) {
      dependency_17 = _aimpactAilearnApp016Dev34SharedCharts;
    }, function (_aimpactAilearnApp016Dev34ComponentsIcons) {
      dependency_18 = _aimpactAilearnApp016Dev34ComponentsIcons;
    ...
    }, function (_aimpactAilearnApp016Dev34Utils) {
      dependency_24 = _aimpactAilearnApp016Dev34Utils;
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.34/assignments/dashboard",
          "multibundle": true
        },
        "type": "widget"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.1.6-dev.34/assignments/dashboard.widget');
      ims = new Map();
      /****************************
