System.register(["@beyond-js/widgets@1.1.0/render", "@beyond-js/kernel@0.1.9/bundle", "@beyond-js/kernel@0.1.9/styles", "@beyond-js/react-18-widgets@1.1.2/page", "@aimpact/ailearn-app@0.1.6-dev.16/dashboard-layout.widget", "@beyond-js/reactive@1.2.0/model", "@aimpact/http-suite@0.0.1/api", "@aimpact/ailearn-sdk@1.0.0/config", "@aimpact/chat-sdk@1.1.0/session", "@beyond-js/kernel@0.1.9/texts", "@aimpact/ailearn-sdk@1.0.0/core", "react@18.2.0", "@aimpact/ailearn-app@0.1.6-dev.16/components/ui", "@aimpact/ailearn-app@0.1.6-dev.16/components/navbar-header.code", "pragmate-ui@1.0.0-beta.2/icons", "@aimpact/ailearn-app@0.1.6-dev.16/config", "pragmate-ui@1.0.0-beta.2/empty", "@aimpact/ailearn-app@0.1.6-dev.16/shared/charts", "@aimpact/ailearn-app@0.1.6-dev.16/components/icons", "pragmate-ui@1.0.0-beta.2/components", "pragmate-ui@1.0.0-beta.2/list", "@beyond-js/react-18-widgets@1.1.2/hooks", "pragmate-ui@1.0.0-beta.2/chips", "pragmate-ui@1.0.0-beta.2/image", "@aimpact/ailearn-app@0.1.6-dev.16/utils", "pragmate-ui@1.0.0-beta.2/tooltip"], function (_export, _context2) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsWidgets110Render) {
    ...
    }, function (_aimpactAilearnApp016Dev16DashboardLayoutWidget) {
      dependency_4 = _aimpactAilearnApp016Dev16DashboardLayoutWidget;
      ...
      dependency_13 = _aimpactAilearnApp016Dev16ComponentsNavbarHeaderCode;
    }, function (_pragmateUi100Beta2Icons) {
      dependency_14 = _pragmateUi100Beta2Icons;
    }, function (_aimpactAilearnApp016Dev16Config) {
      dependency_15 = _aimpactAilearnApp016Dev16Config;
    }, function (_pragmateUi100Beta2Empty) {
      dependency_16 = _pragmateUi100Beta2Empty;
    }, function (_aimpactAilearnApp016Dev16SharedCharts) {
      dependency_17 = _aimpactAilearnApp016Dev16SharedCharts;
    }, function (_aimpactAilearnApp016Dev16ComponentsIcons) {
      dependency_18 = _aimpactAilearnApp016Dev16ComponentsIcons;
    ...
    }, function (_aimpactAilearnApp016Dev16Utils) {
      dependency_24 = _aimpactAilearnApp016Dev16Utils;
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.16/assignments/dashboard",
          "multibundle": true
        },
        "type": "widget"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.1.6-dev.16/assignments/dashboard.widget');
      ims = new Map();
      /****************************
