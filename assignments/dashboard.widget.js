System.register(["@beyond-js/widgets@1.1.0/render", "@beyond-js/kernel@0.1.9/bundle", "@beyond-js/kernel@0.1.9/styles", "@beyond-js/react-18-widgets@1.1.2/page", "@aimpact/ailearn-app@0.1.6-dev.17/dashboard-layout.widget", "@beyond-js/reactive@1.2.0/model", "@aimpact/http-suite@0.0.1/api", "@aimpact/ailearn-sdk@1.0.0/config", "@aimpact/chat-sdk@1.1.0/session", "@beyond-js/kernel@0.1.9/texts", "@aimpact/ailearn-sdk@1.0.0/core", "react@18.2.0", "@aimpact/ailearn-app@0.1.6-dev.17/components/ui", "@aimpact/ailearn-app@0.1.6-dev.17/components/navbar-header.code", "pragmate-ui@1.0.0-beta.2/icons", "@aimpact/ailearn-app@0.1.6-dev.17/config", "pragmate-ui@1.0.0-beta.2/empty", "@aimpact/ailearn-app@0.1.6-dev.17/shared/charts", "@aimpact/ailearn-app@0.1.6-dev.17/components/icons", "pragmate-ui@1.0.0-beta.2/components", "pragmate-ui@1.0.0-beta.2/list", "@beyond-js/react-18-widgets@1.1.2/hooks", "pragmate-ui@1.0.0-beta.2/chips", "pragmate-ui@1.0.0-beta.2/image", "@aimpact/ailearn-app@0.1.6-dev.17/utils", "pragmate-ui@1.0.0-beta.2/tooltip"], function (_export, _context2) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsWidgets110Render) {
      ...
      dependency_13 = _aimpactAilearnApp016Dev17ComponentsNavbarHeaderCode;
    ...
    }, function (_aimpactAilearnApp016Dev17SharedCharts) {
      dependency_17 = _aimpactAilearnApp016Dev17SharedCharts;
    }, function (_aimpactAilearnApp016Dev17ComponentsIcons) {
      dependency_18 = _aimpactAilearnApp016Dev17ComponentsIcons;
    ...
    }, function (_aimpactAilearnApp016Dev17Utils) {
      dependency_24 = _aimpactAilearnApp016Dev17Utils;
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.17/assignments/dashboard",
          "multibundle": true
        },
        "type": "widget"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.1.6-dev.17/assignments/dashboard.widget');
      ims = new Map();
      /****************************
