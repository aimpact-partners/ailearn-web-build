System.register(["@beyond-js/widgets@1.1.0/render", "@beyond-js/kernel@0.1.9/bundle", "@beyond-js/kernel@0.1.9/styles", "@beyond-js/react-18-widgets@1.1.2/page", "@aimpact/ailearn-app@0.1.9/dashboard-layout.widget", "@beyond-js/reactive@1.2.0/model", "@aimpact/http-suite@0.0.1/api", "@aimpact/ailearn-sdk@1.0.0/config", "@aimpact/chat-sdk@1.3.0/session", "@beyond-js/kernel@0.1.9/texts", "@aimpact/ailearn-sdk@1.0.0/core", "react@18.2.0", "@aimpact/ailearn-app@0.1.9/components/ui", "@aimpact/ailearn-app@0.1.9/components/navbar-header.code", "pragmate-ui@1.0.0-beta.6/icons", "@aimpact/ailearn-app@0.1.9/config", "pragmate-ui@1.0.0-beta.6/empty", "@aimpact/ailearn-app@0.1.9/shared/charts", "@aimpact/ailearn-app@0.1.9/components/icons", "pragmate-ui@1.0.0-beta.6/components", "pragmate-ui@1.0.0-beta.6/list", "@beyond-js/react-18-widgets@1.1.2/hooks", "pragmate-ui@1.0.0-beta.6/chips", "pragmate-ui@1.0.0-beta.6/image", "@aimpact/ailearn-app@0.1.9/utils", "pragmate-ui@1.0.0-beta.6/tooltip"], function (_export, _context2) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsWidgets110Render) {
      ...
      dependency_13 = _aimpactAilearnApp019ComponentsNavbarHeaderCode;
    }, function (_pragmateUi100Beta6Icons) {
      dependency_14 = _pragmateUi100Beta6Icons;
    }, function (_aimpactAilearnApp019Config) {
      dependency_15 = _aimpactAilearnApp019Config;
    }, function (_pragmateUi100Beta6Empty) {
      dependency_16 = _pragmateUi100Beta6Empty;
    }, function (_aimpactAilearnApp019SharedCharts) {
      dependency_17 = _aimpactAilearnApp019SharedCharts;
    }, function (_aimpactAilearnApp019ComponentsIcons) {
      dependency_18 = _aimpactAilearnApp019ComponentsIcons;
    ...
    }, function (_aimpactAilearnApp019Utils) {
      dependency_24 = _aimpactAilearnApp019Utils;
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.1.9/assignments/dashboard",
          "multibundle": true
        },
        "type": "widget"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.1.9/assignments/dashboard.widget');
      ims = new Map();
      /****************************
