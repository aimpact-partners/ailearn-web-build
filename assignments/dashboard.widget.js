System.register(["@beyond-js/widgets@1.1.0/render", "@beyond-js/kernel@0.1.9/bundle", "@beyond-js/kernel@0.1.9/styles", "@beyond-js/react-18-widgets@1.1.2/page", "@aimpact/ailearn-app@0.1.0-dev.09/dashboard-layout.widget", "@beyond-js/reactive@1.2.0/model", "@aimpact/http-suite@0.0.1/api", "@aimpact/ailearn-sdk@1.0.0/config", "@aimpact/chat-sdk@1.0.1/session", "@beyond-js/kernel@0.1.9/texts", "@aimpact/ailearn-sdk@1.0.0/core", "react@18.2.0", "@aimpact/ailearn-app@0.1.0-dev.09/components/ui", "@aimpact/ailearn-app@0.1.0-dev.09/components/navbar-header.code", "pragmate-ui@1.0.0-beta.1/icons", "@aimpact/ailearn-app@0.1.0-dev.09/config", "pragmate-ui@1.0.0-beta.1/empty", "@aimpact/ailearn-app@0.1.0-dev.09/shared/charts", "@aimpact/ailearn-app@0.1.0-dev.09/components/icons", "pragmate-ui@1.0.0-beta.1/link", "pragmate-ui@1.0.0-beta.1/list", "pragmate-ui@1.0.0-beta.1/components", "@beyond-js/react-18-widgets@1.1.2/hooks", "pragmate-ui@1.0.0-beta.1/chips", "pragmate-ui@1.0.0-beta.1/image", "@aimpact/ailearn-app@0.1.0-dev.09/utils", "pragmate-ui@1.0.0-beta.1/tooltip"], function (_export, _context2) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsWidgets110Render) {
      ...
      dependency_13 = _aimpactAilearnApp010Dev09ComponentsNavbarHeaderCode;
    ...
    }, function (_aimpactAilearnApp010Dev09SharedCharts) {
      dependency_17 = _aimpactAilearnApp010Dev09SharedCharts;
    ...
    }, function (_aimpactAilearnApp010Dev09Utils) {
      dependency_25 = _aimpactAilearnApp010Dev09Utils;
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.1.0-dev.09/assignments/dashboard",
          "multibundle": true
        },
        "type": "widget"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.1.0-dev.09/assignments/dashboard.widget');
      ims = new Map();
      /****************************
