System.register(["@beyond-js/widgets@1.1.0/render", "@beyond-js/kernel@0.1.9/bundle", "@beyond-js/kernel@0.1.9/styles", "@beyond-js/react-18-widgets@1.1.2/page", "@aimpact/ailearn-app@0.1.3-test.03/dashboard-layout.widget", "@beyond-js/reactive@1.2.0/model", "@aimpact/http-suite@0.0.1/api", "@aimpact/ailearn-sdk@1.0.0/config", "@aimpact/chat-sdk@1.0.1/session", "@beyond-js/kernel@0.1.9/texts", "@aimpact/ailearn-sdk@1.0.0/core", "react@18.2.0", "@aimpact/ailearn-app@0.1.3-test.03/components/ui", "@aimpact/ailearn-app@0.1.3-test.03/components/navbar-header.code", "pragmate-ui@1.0.0-beta.1/icons", "@aimpact/ailearn-app@0.1.3-test.03/config", "pragmate-ui@1.0.0-beta.1/empty", "@aimpact/ailearn-app@0.1.3-test.03/shared/charts", "@aimpact/ailearn-app@0.1.3-test.03/components/icons", "pragmate-ui@1.0.0-beta.1/link", "pragmate-ui@1.0.0-beta.1/list", "pragmate-ui@1.0.0-beta.1/components", "@beyond-js/react-18-widgets@1.1.2/hooks", "pragmate-ui@1.0.0-beta.1/chips", "pragmate-ui@1.0.0-beta.1/image", "@aimpact/ailearn-app@0.1.3-test.03/utils", "pragmate-ui@1.0.0-beta.1/tooltip"], function (_export, _context2) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsWidgets110Render) {
      ...
      dependency_13 = _aimpactAilearnApp013Test03ComponentsNavbarHeaderCode;
    ...
    }, function (_aimpactAilearnApp013Test03SharedCharts) {
      dependency_17 = _aimpactAilearnApp013Test03SharedCharts;
    }, function (_aimpactAilearnApp013Test03ComponentsIcons) {
      dependency_18 = _aimpactAilearnApp013Test03ComponentsIcons;
    ...
    }, function (_aimpactAilearnApp013Test03Utils) {
      dependency_25 = _aimpactAilearnApp013Test03Utils;
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.1.3-test.03/assignments/dashboard",
          "multibundle": true
        },
        "type": "widget"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.1.3-test.03/assignments/dashboard.widget');
      ims = new Map();
      /****************************
