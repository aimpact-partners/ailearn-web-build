System.register(["@beyond-js/widgets@1.1.0/render", "@beyond-js/kernel@0.1.9/bundle", "@beyond-js/kernel@0.1.9/styles", "@beyond-js/react-18-widgets@1.1.2/page", "@aimpact/ailearn-app@0.1.6-dev.21/dashboard-layout.widget", "@beyond-js/reactive@1.2.0/model", "@aimpact/http-suite@0.0.1/api", "@aimpact/ailearn-sdk@1.0.0/config", "@aimpact/chat-sdk@1.1.0/session", "@beyond-js/kernel@0.1.9/texts", "@aimpact/ailearn-sdk@1.0.0/core", "react@18.3.1", "@aimpact/ailearn-app@0.1.6-dev.21/components/ui", "@aimpact/ailearn-app@0.1.6-dev.21/components/navbar-header.code", "pragmate-ui@1.0.0-beta.6/icons", "@aimpact/ailearn-app@0.1.6-dev.21/config", "pragmate-ui@1.0.0-beta.6/empty", "@aimpact/ailearn-app@0.1.6-dev.21/shared/charts", "@aimpact/ailearn-app@0.1.6-dev.21/components/icons", "pragmate-ui@1.0.0-beta.6/components", "pragmate-ui@1.0.0-beta.6/list", "@beyond-js/react-18-widgets@1.1.2/hooks", "pragmate-ui@1.0.0-beta.6/chips", "pragmate-ui@1.0.0-beta.6/image", "@aimpact/ailearn-app@0.1.6-dev.21/utils", "pragmate-ui@1.0.0-beta.6/tooltip"], function (_export, _context2) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsWidgets110Render) {
      ...
      dependency_13 = _aimpactAilearnApp016Dev21ComponentsNavbarHeaderCode;
    ...
    }, function (_aimpactAilearnApp016Dev21SharedCharts) {
      dependency_17 = _aimpactAilearnApp016Dev21SharedCharts;
    }, function (_aimpactAilearnApp016Dev21ComponentsIcons) {
      dependency_18 = _aimpactAilearnApp016Dev21ComponentsIcons;
    ...
    }, function (_aimpactAilearnApp016Dev21Utils) {
      dependency_24 = _aimpactAilearnApp016Dev21Utils;
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.21/assignments/dashboard",
          "multibundle": true
        },
        "type": "widget"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.1.6-dev.21/assignments/dashboard.widget');
      ims = new Map();
      /****************************
