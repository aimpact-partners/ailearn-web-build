System.register(["@beyond-js/widgets@0.1.5/render", "@beyond-js/kernel@0.1.9/bundle", "@beyond-js/kernel@0.1.9/styles", "@beyond-js/react-18-widgets@1.0.3/page", "@aimpact/ailearn-sdk@1.0.0/core", "@beyond-js/reactive@1.1.6/model", "@aimpact/chat-sdk@1.0.0/voice", "@aimpact/chat@1.0.1/wrapper", "react@18.2.0", "pragmate-ui@0.0.3/components", "@beyond-js/react-18-widgets@1.0.3/hooks", "@aimpact/chat@1.0.1/shared/hooks", "pragmate-ui@0.0.3/icons", "pragmate-ui@0.0.3/tabs", "@aimpact/ailearn-app@0.0.14/components/ui", "@aimpact/ailearn-app@0.0.14/chat/messages", "@aimpact/chat-sdk@1.0.0/widgets/markdown", "pragmate-ui@0.0.3/empty", "@bgroup/media-manager@1.0.0/audio-player", "pragmate-ui@0.0.3/list", "pragmate-ui@0.0.3/alert"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsWidgets015Render) {
      ...
      dependency_14 = _aimpactAilearnApp0014ComponentsUi;
    }, function (_aimpactAilearnApp0014ChatMessages) {
      dependency_15 = _aimpactAilearnApp0014ChatMessages;
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.0.14/assignments/dashboard/participant",
          "multibundle": true
        },
        "type": "widget"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.0.14/assignments/dashboard/participant.widget');
      ims = new Map();
      /****************************
