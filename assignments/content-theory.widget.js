System.register(["@beyond-js/widgets@1.1.1/render", "@beyond-js/kernel@0.1.9/bundle", "@beyond-js/react-18-widgets@1.1.3/page", "@aimpact/ailearn-app@0.3.20/assignments/chat", "@aimpact/ailearn-app@0.3.20/main-layout.widget", "@aimpact/ailearn-app@0.3.20/entities/assignments/activities/base"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsWidgets111Render) {
      ...
      dependency_3 = _aimpactAilearnApp0320AssignmentsChat;
      ...
      dependency_5 = _aimpactAilearnApp0320EntitiesAssignmentsActivitiesBase;
    }],
    execute: function () {
      bimport = specifier => {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.3.20/assignments/content-theory",
          "multibundle": true
        },
        "type": "widget"
