System.register(["@beyond-js/widgets@1.1.3/render", "@beyond-js/kernel@0.1.12/bundle", "@beyond-js/react-18-widgets@1.1.4/page", "@aimpact/ailearn-app@0.3.32/assignments/chat", "@aimpact/ailearn-app@0.3.32/main-layout.widget", "@aimpact/ailearn-app@0.3.32/entities/assignments/activities/base"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsWidgets113Render) {
      ...
      dependency_3 = _aimpactAilearnApp0332AssignmentsChat;
      ...
      dependency_5 = _aimpactAilearnApp0332EntitiesAssignmentsActivitiesBase;
    }],
    execute: function () {
      bimport = specifier => {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.3.32/assignments/content-theory",
          "multibundle": true
        },
        "type": "widget"
