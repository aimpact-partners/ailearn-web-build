System.register(["@beyond-js/widgets@1.1.0/render", "@beyond-js/kernel@0.1.9/bundle", "@beyond-js/kernel@0.1.9/styles", "@beyond-js/react-18-widgets@1.1.2/page", "@beyond-js/reactive@1.2.0/model", "@beyond-js/kernel@0.1.9/texts", "@aimpact/ailearn-app@0.1.0-dev.08/main-layout.widget", "@aimpact/ailearn-sdk@1.0.0/tracking", "react@18.2.0", "framer-motion@10.18.0", "pragmate-ui@1.0.0-beta.1/components", "@aimpact/ailearn-app@0.1.0-dev.08/components/ui", "@beyond-js/react-18-widgets@1.1.2/hooks", "@aimpact/chat-sdk@1.0.1/widgets/markdown", "@aimpact/chat@1.0.2/wrapper", "@aimpact/ailearn-app@0.1.0-dev.08/components/hooks", "pragmate-ui@1.0.0-beta.1/collapsible", "@aimpact/chat@1.0.2/shared/components", "@aimpact/ailearn-app@0.1.0-dev.08/components/icons"], function (_export, _context2) {
  ...
  return {
    setters: [function (_beyondJsWidgets110Render) {
      ...
      dependency_15 = _aimpactAilearnApp010Dev08ComponentsHooks;
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.1.0-dev.08/assignments/content-theory",
          "multibundle": true
        },
        "type": "widget"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.1.0-dev.08/assignments/content-theory.widget');
      ims = new Map();
      /****************************
