System.register(["@beyond-js/widgets@1.1.1/render", "@beyond-js/kernel@0.1.9/bundle", "@beyond-js/kernel@0.1.9/styles", "@beyond-js/react-18-widgets@1.1.2/page", "@aimpact/ailearn-sdk@1.0.0/application", "@aimpact/chat-sdk@1.4.1/session", "@aimpact/reactive@0.0.1/model", "react@18.2.0", "@aimpact/chat-sdk@1.4.1/widgets/markdown", "@beyond-js/react-18-widgets@1.1.2/hooks", "pragmate-ui@1.0.0-beta.7/components", "react@18.2.0/jsx-runtime"], function (_export, _context) {
  "use strict";
  ...
  return {
    ...
    execute: function () {
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.3.1/pages/privacy');
      ims = new Map();
      /****************************
