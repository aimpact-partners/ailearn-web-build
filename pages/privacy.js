System.register(["@beyond-js/widgets@1.1.3/render", "@beyond-js/kernel@0.1.12/bundle", "@beyond-js/kernel@0.1.12/styles", "@beyond-js/react-18-widgets@1.1.4/page", "@aimpact/ailearn-sdk@1.1.0/application", "@aimpact/chat-sdk@1.4.3/session", "@aimpact/reactive@0.0.1/model", "react@18.3.1", "@aimpact/chat-sdk@1.4.3/widgets/markdown", "@beyond-js/react-18-widgets@1.1.4/hooks", "pragmate-ui@1.0.0-beta.7/components", "react@18.3.1/jsx-runtime"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsWidgets113Render) {
      ...
      dependency_8 = _aimpactChatSdk143WidgetsMarkdown;
    ...
    execute: function () {
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.3.32/pages/privacy');
      ims = new Map();
      /****************************
