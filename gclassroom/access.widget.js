System.register(["@beyond-js/widgets@1.1.1/render", "@beyond-js/kernel@0.1.9/bundle", "@beyond-js/kernel@0.1.9/styles", "@beyond-js/react-18-widgets@1.1.2/page", "@beyond-js/reactive@1.1.12/model", "@aimpact/ailearn-app@0.2.15/model/gclassroom", "react@18.2.0", "@beyond-js/react-18-widgets@1.1.2/hooks", "@aimpact/ailearn-app@0.2.15/components/ui", "pragmate-ui@1.0.0-beta.7/alert", "pragmate-ui@1.0.0-beta.7/image"], function (_export, _context) {
  ...
  return {
    setters: [function (_beyondJsWidgets111Render) {
      ...
      dependency_5 = _aimpactAilearnApp0215ModelGclassroom;
    }, function (_react2) {
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.2.15/gclassroom/access",
          "multibundle": true
        },
        "type": "widget"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.2.15/gclassroom/access.widget');
      ims = new Map();
      /****************************
