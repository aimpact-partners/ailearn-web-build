System.register(["@beyond-js/widgets@1.1.0/render", "@beyond-js/kernel@0.1.9/bundle", "@beyond-js/reactive@1.2.0/model", "@aimpact/ailearn-app@0.1.6-dev.11/widgets/breadcrumb.widget", "@aimpact/ailearn-app@0.1.6-dev.11/i18n.ts", "@beyond-js/react-18-widgets@1.1.2/base", "@aimpact/chat-sdk@1.1.0/core", "@aimpact/chat-sdk@1.1.0/wrapper", "@beyond-js/kernel@0.1.9/texts", "pragmate-ui@1.0.0-beta.2/modal", "react@18.2.0", "pragmate-ui@1.0.0-beta.2/components", "pragmate-ui@1.0.0-beta.2/chips", "@aimpact/ailearn-app@0.1.6-dev.11/components/ui", "@beyond-js/react-18-widgets@1.1.2/hooks", "pragmate-ui@1.0.0-beta.2/icons", "framer-motion@10.18.0", "@aimpact/ailearn-app@0.1.6-dev.11/components/navbar-header.code", "pragmate-ui@1.0.0-beta.2/toast", "@beyond-js/kernel@0.1.9/styles"], function (_export, _context2) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsWidgets110Render) {
      ...
      dependency_3 = _aimpactAilearnApp016Dev11WidgetsBreadcrumbWidget;
    }, function (_aimpactAilearnApp016Dev11I18nTs) {
      dependency_4 = _aimpactAilearnApp016Dev11I18nTs;
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.11/main-layout",
          "multibundle": true
        },
        "type": "widget"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.1.6-dev.11/main-layout.widget');
      ims = new Map();
      /************************
