System.register(["@beyond-js/kernel@0.1.9/bundle", "react@18.2.0", "pragmate-ui@1.0.0-beta.1/icons", "@aimpact/chat@1.0.2/components/icons", "@aimpact/ailearn-app@0.1.4-test.05/components/ui", "@beyond-js/react-18-widgets@1.1.2/hooks", "pragmate-ui@1.0.0-beta.1/toast", "@aimpact/chat-sdk@1.0.1/session", "@aimpact/chat@1.0.2/shared/icons", "@aimpact/chat-sdk@1.0.1/widgets/playable", "@aimpact/chat@1.0.2/shared/hooks", "pragmate-ui@1.0.0-beta.1/collapsible"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.1.4-test.05/chat/messages"
        },
        "type": "code"
