System.register(["@beyond-js/kernel@0.1.9/bundle", "react@18.2.0", "pragmate-ui@1.0.0-beta.2/icons", "@aimpact/chat@1.0.2/components/icons", "@aimpact/ailearn-app@0.1.6-dev.04/components/ui", "@beyond-js/react-18-widgets@1.1.2/hooks", "pragmate-ui@1.0.0-beta.2/toast", "@aimpact/chat-sdk@1.0.1/session", "@aimpact/chat@1.0.2/shared/icons", "@aimpact/chat-sdk@1.0.1/widgets/playable", "@aimpact/chat@1.0.2/shared/hooks", "pragmate-ui@1.0.0-beta.2/collapsible"], function (_export, _context) {
  "use strict";
  ...
  return {
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.04/chat/messages"
        },
        "type": "code"
