System.register(["@beyond-js/widgets@1.1.0/render", "@beyond-js/kernel@0.1.9/bundle", "@beyond-js/kernel@0.1.9/styles", "@beyond-js/react-18-widgets@1.1.2/page", "@beyond-js/reactive@1.1.12/model", "@aimpact/ailearn-sdk@1.0.0/core", "react@18.2.0", "@aimpact/ailearn-app@0.0.43/components/navbar-header.code", "@aimpact/ailearn-app@0.0.43/config", "pragmate-ui@0.1.1/image", "@aimpact/ailearn-app@0.0.43/components/ui", "@aimpact/chat@1.0.1/shared/components", "@aimpact/chat@1.0.1/shared/hooks", "pragmate-ui@0.1.1/form", "pragmate-ui@0.1.1/toast", "pragmate-ui@0.1.1/code-verification", "pragmate-ui@0.1.1/components", "@beyond-js/kernel@0.1.9/routing", "@beyond-js/react-18-widgets@1.1.2/hooks"], function (_export, _context2) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsWidgets110Render) {
      ...
      dependency_8 = _aimpactAilearnApp0043Config;
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.0.43/classrooms/join",
          "multibundle": true
        },
        "type": "widget"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.0.43/classrooms/join.widget');
      ims = new Map();
      /****************************
