System.register(["@beyond-js/widgets@1.1.0/render", "@beyond-js/kernel@0.1.9/bundle", "@beyond-js/kernel@0.1.9/styles", "@beyond-js/react-18-widgets@1.1.2/page", "@beyond-js/reactive@1.1.12/model", "@aimpact/ailearn-sdk@1.0.0/core", "@aimpact/ailearn-app@0.0.55/model/gclassroom", "dayjs@1.11.10", "@aimpact/ailearn-app@0.0.55/main-layout.widget", "@beyond-js/kernel@0.1.9/texts", "react@18.2.0", "pragmate-ui@0.1.1/list", "@aimpact/ailearn-app@0.0.55/components/ui", "pragmate-ui@0.1.1/icons", "pragmate-ui@0.1.1/link", "@beyond-js/react-18-widgets@1.1.2/hooks", "pragmate-ui@0.1.1/components", "@aimpact/ailearn-app@0.0.55/components/icons", "@aimpact/chat-sdk@1.0.1/session", "pragmate-ui@0.1.1/alert", "pragmate-ui@0.1.1/modal", "pragmate-ui@0.1.1/toast", "@aimpact/chat@1.0.2/shared/components", "@aimpact/chat@1.0.2/shared/hooks"], function (_export, _context2) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsWidgets110Render) {
      ...
      dependency_6 = _aimpactAilearnApp0055ModelGclassroom;
    }, function (_dayjs2) {
      dependency_7 = _dayjs2;
    }, function (_aimpactAilearnApp0055MainLayoutWidget) {
      dependency_8 = _aimpactAilearnApp0055MainLayoutWidget;
      ...
      dependency_17 = _aimpactAilearnApp0055ComponentsIcons;
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.0.55/classrooms/list",
          "multibundle": true
        },
        "type": "widget"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.0.55/classrooms/list.widget');
      ims = new Map();
      /****************************
