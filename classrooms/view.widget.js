System.register(["@beyond-js/widgets@1.1.0/render", "@beyond-js/kernel@0.1.9/bundle", "@beyond-js/kernel@0.1.9/styles", "@beyond-js/react-18-widgets@1.1.2/page", "@aimpact/ailearn-sdk@1.0.0/core", "@beyond-js/reactive@1.2.0/model", "@aimpact/ailearn-app@0.1.4-test.02/main-layout.widget", "@beyond-js/kernel@0.1.9/texts", "@aimpact/chat-sdk@1.0.1/session", "@aimpact/ailearn-app@0.1.4-test.02/components/navbar-header.code", "react@18.2.0", "@aimpact/ailearn-app@0.1.4-test.02/config", "pragmate-ui@1.0.0-beta.1/components", "@aimpact/ailearn-app@0.1.4-test.02/components/ui", "pragmate-ui@1.0.0-beta.1/icons", "pragmate-ui@1.0.0-beta.1/toast", "@aimpact/ailearn-app@0.1.4-test.02/components/cover-image.code", "@aimpact/chat@1.0.2/shared/hooks", "@beyond-js/react-18-widgets@1.1.2/hooks", "@aimpact/chat@1.0.2/shared/components", "pragmate-ui@1.0.0-beta.1/form/react-select", "pragmate-ui@1.0.0-beta.1/list", "pragmate-ui@1.0.0-beta.1/image", "framer-motion@10.18.0", "pragmate-ui@1.0.0-beta.1/form", "pragmate-ui@1.0.0-beta.1/modal"], function (_export, _context2) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsWidgets110Render) {
      ...
      dependency_9 = _aimpactAilearnApp014Test02ComponentsNavbarHeaderCode;
    }, function (_react2) {
      dependency_10 = _react2;
    }, function (_aimpactAilearnApp014Test02Config) {
      dependency_11 = _aimpactAilearnApp014Test02Config;
      ...
      dependency_16 = _aimpactAilearnApp014Test02ComponentsCoverImageCode;
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.1.4-test.02/classrooms/view",
          "multibundle": true
        },
        "type": "widget"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.1.4-test.02/classrooms/view.widget');
      ims = new Map();
      /****************************
