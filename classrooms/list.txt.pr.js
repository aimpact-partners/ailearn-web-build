      ...
      *********************/
      ims.set('./txt', {
        ...
        creator: function (require, exports) {
          exports.txt = {
            "welcome": {
              "message": "Bem-vindo %name à sua lista de aulas",
              "actionInfo": "Aqui, você pode visualizar e gerenciar todas as classes que você possui atualmente. Tenha acesso a várias ações, incluindo a criação, exclusão e edição de classes. Utilize essas ferramentas para personalizar cada classe de acordo com seus requisitos."
            },
            "import": {
              "title": "Importação de classes do Google"
            },
            "title": "Minhas Aulas",
            "subtitle": "Explore, ajuste e gerencie suas aulas de acordo com suas necessidades",
            "extraInfo": "Pronto para compartilhar suas aulas? Vincule sua conta do Google Classroom para habilitar essa opção e adicioná-la às suas escolhas! 📚",
            "errors": {
