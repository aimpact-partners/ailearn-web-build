      ...
      ims.set('./txt', {
        ...
        creator: function (require, exports) {
          exports.txt = {
            ...
            "filter": {
              "title": "Filtrar Comunidad",
              "description": "Indique las características del tipo de módulo de aprendizaje que busca"
            },
            "filters": {
              "audience": {
                "label": "Tipo de formación",
                "error": "Por favor seleccione la audiencia",
                "select": "Toda la audiencia"
              },
              "level": {
                "label": "Grado o Nivel",
                "error": "Por favor seleccione un nivel de grado",
                "select": "Todos los grados"
              },
              "languages": {
                "select": {
                  "label": "Idioma",
