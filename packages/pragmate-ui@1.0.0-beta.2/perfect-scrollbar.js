System.register(["@beyond-js/kernel@0.1.9/bundle", "@beyond-js/kernel@0.1.9/styles", "react@18.2.0", "perfect-scrollbar@1.5.5", "pragmate-ui@1.0.0-beta.2/base"], function (_export, _context) {
  "use strict";
  ...
  return {
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "pragmate-ui@1.0.0-beta.2/perfect-scrollbar"
        },
        "type": "code",
      ...
      brequire('@beyond-js/kernel/styles').styles.register('pragmate-ui@1.0.0-beta.2/perfect-scrollbar');
      ims = new Map();
      /***************************
