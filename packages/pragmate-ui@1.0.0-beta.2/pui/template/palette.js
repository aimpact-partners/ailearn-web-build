System.register(["@beyond-js/widgets@1.1.0/render", "@beyond-js/kernel@0.1.9/bundle", "@beyond-js/kernel@0.1.9/styles", "@beyond-js/react-18-widgets@1.1.2/base", "pragmate-ui@1.0.0-beta.2/template/manager", "react@18.2.0", "pragmate-ui@1.0.0-beta.2/components", "pragmate-ui@1.0.0-beta.2/theme-switcher", "pragmate-ui@1.0.0-beta.2/tooltip", "@beyond-js/react-18-widgets@1.1.2/hooks"], function (_export, _context) {
  ...
  return {
    ...
    }, function (_pragmateUi100Beta2TemplateManager) {
      dependency_4 = _pragmateUi100Beta2TemplateManager;
    }, function (_react2) {
      dependency_5 = _react2;
    }, function (_pragmateUi100Beta2Components) {
      dependency_6 = _pragmateUi100Beta2Components;
    }, function (_pragmateUi100Beta2ThemeSwitcher) {
      dependency_7 = _pragmateUi100Beta2ThemeSwitcher;
    ...
    execute: function () {
      ...
      brequire('@beyond-js/kernel/styles').styles.register('pragmate-ui@1.0.0-beta.2/pui/template/palette');
      ims = new Map();
      /****************************
