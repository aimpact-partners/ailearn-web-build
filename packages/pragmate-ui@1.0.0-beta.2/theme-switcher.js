System.register(["@beyond-js/kernel@0.1.9/bundle", "@beyond-js/kernel@0.1.9/styles", "react@18.2.0", "pragmate-ui@1.0.0-beta.2/form", "pragmate-ui@1.0.0-beta.2/icons"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsKernel019Bundle) {
      ...
      dependency_3 = _pragmateUi100Beta2Form;
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "pragmate-ui@1.0.0-beta.2/theme-switcher"
        },
        "type": "code"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('pragmate-ui@1.0.0-beta.2/theme-switcher');
      ims = new Map();
      /***********************
