System.register(["@firebase/util@1.12.0","@firebase/component@0.6.17","@firebase/logger@0.4.4","idb@7.1.1","@firebase/app@0.13.1"], (_exports, _context) => {

const bimport = specifier => {
	const dependencies = new Map([["@firebase/util","1.12.0"],["@firebase/component","0.6.17"],["@firebase/logger","0.4.4"],["idb","7.1.1"],["@firebase/app","0.13.1"],["firebase","11.9.1"]]);
...
return {
setters: [dep => dependencies.set('@firebase/util@1.12.0', dep), dep => dependencies.set('@firebase/component@0.6.17', dep), dep => dependencies.set('@firebase/logger@0.4.4', dep), dep => dependencies.set('idb@7.1.1', dep), dep => dependencies.set('@firebase/app@0.13.1', dep)],
execute: function() {
...
__reExport(index_esm_exports, require("@firebase/app@0.13.1"));
var name = "firebase";
var version = "11.9.1";
