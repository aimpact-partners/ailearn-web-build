System.register(["@beyond-js/kernel@0.1.9/bundle", "@beyond-js/kernel@0.1.9/styles", "react@18.2.0", "@beyond-js/react-18-widgets@1.1.1/hooks", "@beyond-js/reactive@1.1.12/model", "pragmate-ui@0.1.0/icons"], function (_export, _context) {
  "use strict";
  ...
  return {
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "pragmate-ui@0.1.0/toast"
        },
        "type": "code"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('pragmate-ui@0.1.0/toast');
      ims = new Map();
      /***********************
