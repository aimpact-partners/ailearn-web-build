System.register(["@beyond-js/kernel@0.1.9/bundle", "react@18.2.0", "pragmate-ui@0.1.0/icons", "@beyond-js/kernel@0.1.9/styles"], function (_export, _context) {
  "use strict";
  ...
  return {
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "pragmate-ui@0.1.0/alert"
        },
        "type": "code",
        "name": "alert"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('pragmate-ui@0.1.0/alert');
      ims = new Map();
      /***********************
