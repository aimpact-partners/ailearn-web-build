System.register(["@beyond-js/kernel@0.1.14/bundle", "@beyond-js/kernel@0.1.14/styles", "pragmate-ui@1.0.8/icons", "react@18.3.1", "prismjs@1.30.0", "pragmate-ui@1.0.8/toast"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsKernel0114Bundle) {
      ...
      dependency_5 = _pragmateUi108Toast;
    }],
    execute: function () {
      bimport = specifier => {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "pragmate-ui@1.0.8/code"
        },
        "type": "code"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('pragmate-ui@1.0.8/code');
      ims = new Map();
      /***************************
