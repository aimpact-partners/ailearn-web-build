System.register(["@beyond-js/kernel@0.1.14/bundle", "react@18.3.1", "@beyond-js/reactive@2.1.1/model", "pragmate-ui@1.0.8/base", "pragmate-ui@1.0.8/icons", "@beyond-js/kernel@0.1.14/styles"], function (_export, _context2) {
  "use strict";
  ...
  return {
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "pragmate-ui@1.0.8/context-menu"
        },
        "type": "code"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('pragmate-ui@1.0.8/context-menu');
      ims = new Map();
      /***************************
