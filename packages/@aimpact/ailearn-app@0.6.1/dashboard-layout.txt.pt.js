          ...
          exports.txt = {
            ...
            "coins": {
              "alert": {
                ...
                "description": "Você precisa obter créditos de IA para habilitar todas as funções com inteligência artificial.",
                "action": "Aceitar"
              },
              "modal": {
                "title": "Solicite créditos de IA para continuar com essa função",
                "description": "Você precisa obter créditos de IA para habilitar todas as funções com inteligência artificial.",
                "actions": {
                  "cancel": "Não, por enquanto, obrigado",
              ...
              "header": {
                ...
                "messages": {
                  "add": "Você adquiriu créditos para usar as funções com IA",
            ...
            "notifications": {
              "saved": "Solicite créditos de IA para habilitar todas as funções com inteligência artificial.",
              "credits": "Você já tem <strong>créditos atribuídos</strong> para usar funções com IA que serão descontados automaticamente com o uso."
            }
          };
        }
      });
