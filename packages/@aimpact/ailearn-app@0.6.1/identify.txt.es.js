System.register(["@beyond-js/kernel@0.1.14/bundle"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.6.1/identify",
          "multibundle": true
        },
        "type": "txt"
          ...
          exports.txt = {
            ...
            "requested": {
              ...
              "teacherInstitution": {
                ...
                "description": "Por favor, espera la aprobación del administrador para acceder al espacio educativo de la institución. <strong>Revisa tu correo electrónico</strong> donde te notificaremos una vez que tu solicitud haya sido aprobada para poder acceder a <strong>RVD.AI</strong>."
              },
              "teacherApproved": {
              ...
              "student": {
                ...
                "description": "Por favor, espera la aprobación del profesor para acceder al aula. <strong>Revisa tu correo electrónico</strong> donde te notificaremos una vez que tu solicitud haya sido aprobada para poder acceder a <strong>RVD.AI</strong>."
              },
              "studentApproved": {
                "title": "¡Felicitaciones! Tu solicitud ha sido aprobada",
            ...
            "teacher": {
              ...
              "institution": {
                "intro": {
                  ...
                  "options": {
                    "yes": {
                      "label": "Sí",
                      "description": "Mi institución ya trabaja con <strong>RVD.AI</strong> y quiero sumarme a su espacio educativo."
                    },
                    "no": {
                      "label": "No",
                      "description": "Mi institución no trabaja con <strong>RVD.AI</strong>. Quiero sumarme a la herramienta como docente independiente."
                    }
                  }
                },
                "form": {
              ...
              "welcome": {
                "user": {
                  "hello": "¡Hola {username}!",
                  "description": "Bienvenido a RVD.AI"
                }
              },
              "processed": {
            ...
            "welcome": {
              "hello": "¡Hola {username}!",
              "description": "Bienvenido/a a RVD.AI"
            },
            "actions": {
              "accept": "ACEPTAR",
              "back": "VOLVER",
