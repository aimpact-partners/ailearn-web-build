      ...
      *********************/
      ims.set('./txt', {
        ...
        creator: function (require, exports) {
          exports.txt = {
            "ERROR": "A solicitação não pôde ser processada. Por favor, tente novamente mais tarde.",
            "checkbox": "<strong>Aceito</strong> os termos e condições do AILearn.",
            "button": "Aceitar",
            "claim": "O AILearn utiliza inteligência artificial para fornecer guias de estudo. Lembre-se de verificar as respostas obtidas.",
            "actions": {
              "save": "Enviar"
            },
            "terms": {
              "title": "Termos e condições",
              "claim": "<strong>AILearn</strong> se apoia na inteligência artificial para auxiliar no aprendizado. É necessário supervisionar e verificar as respostas que a IA fornece aos alunos.",
              "conclusion": "Para continuar, você deve aceitar os",
              "postConclusion": "e",
              "links": {
            ...
            "age": {
              "title": "Verificação de maioridade",
              "validation": "Declaro que os dados inseridos são verdadeiros e me responsabilizo por isso."
            },
            "months": {
              "label": "Mês",
