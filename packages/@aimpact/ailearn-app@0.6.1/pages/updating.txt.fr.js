      ...
      *********************/
      ims.set('./txt', {
        ...
        creator: function (require, exports) {
          exports.txt = {
            "title": "Nous mettons à jour vos données !",
            "text": "Il semble que vous deviez mettre à jour vos informations pour continuer. Veuillez attendre quelques instants et recharger la page plus tard.",
            "action": "Recharger",
            "updating": "Nous mettons toujours à jour vos données. Veuillez attendre encore quelques instants et recharger la page plus tard."
          };
        }
      });
