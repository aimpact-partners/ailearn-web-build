      ...
      *********************/
      ims.set('./txt', {
        ...
        creator: function (require, exports) {
          exports.txt = {
            "ERROR": "La demande n'a pas pu être traitée. Veuillez réessayer plus tard.",
            "checkbox": "<strong>J'accepte</strong> les termes et conditions d'AILearn.",
            "button": "Accepter",
            "claim": "AILearn utilise l'intelligence artificielle pour vous fournir des guides d'étude. N'oubliez pas de vérifier les réponses obtenues.",
            "actions": {
              "save": "Soumettre"
            },
            "terms": {
              "title": "Termes et conditions",
              "claim": "<strong>AILearn</strong> s'appuie sur l'intelligence artificielle pour assister l'apprentissage. Il est nécessaire de superviser et vérifier les réponses que l'IA fournit aux élèves.",
              "conclusion": "Pour continuer, vous devez accepter les",
              "postConclusion": "et",
              "links": {
            ...
            "age": {
              ...
              "validation": "Je déclare que les données saisies sont vraies et j'en suis responsable."
            },
            "months": {
              "label": "Mois",
            ...
            "days": {
              "label": "Jour",
              "items": ["Dimanche", "Lundi", "Mardi", "Mercredi", "Jeudi", "Vendredi", "Samedi"]
            },
            "years": {
              "label": "Année"
            },
