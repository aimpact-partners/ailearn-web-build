System.register(["@beyond-js/kernel@0.1.12/bundle", "react@18.3.1", "@radix-ui/react-icons@1.3.2", "pragmate-ui@1.0.8/components", "@beyond-js/kernel@0.1.12/styles"], function (_export, _context) {
  "use strict";
  ...
  return {
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.6.1/components/tags-input"
        },
        "type": "code"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.6.1/components/tags-input');
      ims = new Map();
      /***********************
