      ...
      ims.set('./txt', {
        ...
        creator: function (require, exports) {
          exports.txt = {
            ...
            "description": "Il semble que vous ayez accédé à une zone restreinte. Notre système a détecté une tentative d'accès non autorisée, mais ne vous inquiétez pas, vous pouvez toujours explorer d'autres sections de notre site web. N'hésitez pas à revenir à la page d'accueil ou à naviguer parmi nos routes numériques disponibles. À l'ère de l'information, chaque clic est une opportunité de découverte.",
