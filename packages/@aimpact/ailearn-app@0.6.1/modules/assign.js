System.register(["@beyond-js/kernel@0.1.14/bundle", "@aimpact/ailearn-app@0.6.1/components/ui", "pragmate-ui@1.0.8/components", "pragmate-ui@1.0.8/list", "react@18.3.1", "pragmate-ui@1.0.8/empty", "pragmate-ui@1.0.8/modal", "@aimpact/ailearn-app@0.6.1/components/icons", "pragmate-ui@1.0.8/toast", "@aimpact/ailearn-app@0.6.1/model/wrapper", "@beyond-js/reactive@2.1.1/model", "@aimpact/ailearn-sdk@1.2.0/entities/classrooms", "@aimpact/chat-sdk@1.5.5/session", "@beyond-js/kernel@0.1.14/styles"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.6.1/modules/assign"
        },
        "type": "code"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.6.1/modules/assign');
      ims = new Map();
      /****************************
