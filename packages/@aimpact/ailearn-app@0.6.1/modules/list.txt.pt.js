        ...
        creator: function (require, exports) {
          exports.txt = {
            ...
            "delete": {
              ...
              "description": "Tem certeza de que deseja excluir este módulo? Esta ação não pode ser desfeita.",
              "errors": {
                "59": "O módulo não pode ser excluído porque já possui dados associados.",
                "default": "Ocorreu um erro ao excluir o módulo."
              }
            },
            "archive": {
              "title": "Arquivar módulo",
              "description": "Tem certeza de que deseja arquivar este módulo?",
              "errors": {
                "default": "Ocorreu um erro ao arquivar o módulo."
              }
            },
            "empty": {
              "general": {
                "title": "Crie Seu Primeiro Módulo",
                "description": "Modernize sua abordagem de ensino dando vida ao seu primeiro módulo. Liberte sua criatividade, molde seu conteúdo e aproveite a experiência de aprender! "
              },
              "drafts": {
                "title": "Ainda não há Rascunhos",
                "description": "Você não tem rascunhos no momento. Comece a criar e aperfeiçoar seu conteúdo antes de publicar. "
              },
              "published": {
            ...
            "errors": {
              "default": "Não foi possível realizar a operação. Por favor, tente novamente.",
              "ERROR_GETTING_URL": "Erro ao obter a url"
            },
