System.register(["@beyond-js/kernel@0.1.12/bundle"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.6.1/modules/owner-assign",
          "multibundle": true
        },
        "type": "txt"
      ...
      ims.set('./txt', {
        ...
        creator: function (require, exports) {
          exports.txt = {
            ...
            "title": "Indiquer un propriétaire",
            "description": "Le propriétaire du module d'apprentissage sera le fournisseur des crédits IA nécessaires pour son édition et l'interaction des élèves.",
            "me": {
              "label": "Je serai le propriétaire",
              "description": "Je serai l'administrateur et le fournisseur de crédits IA du module"
            },
            "organization": {
              "label": "Assigner à une institution éducative",
              "description": "L'institution sélectionnée sera l'administrateur et le fournisseur de crédits IA du module"
            },
            "institution": {
              "label": "Institution éducative"
            }
          };
        }
      });
