System.register(["@beyond-js/widgets@1.1.2/render", "@beyond-js/kernel@0.1.14/bundle", "@beyond-js/kernel@0.1.14/styles", "@beyond-js/react-18-widgets@1.1.8/base", "@aimpact/ailearn-app@0.6.1/model/gclassroom", "@beyond-js/reactive@2.1.1/model", "@aimpact/chat-sdk@1.5.5/core", "dayjs@1.11.13", "react@18.3.1", "pragmate-ui@1.0.8/icons", "pragmate-ui@1.0.8/components", "@beyond-js/react-18-widgets@1.1.8/hooks", "@aimpact/ailearn-app@0.6.1/model/wrapper", "@beyond-js/kernel@0.1.14/routing"], function (_export, _context2) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsWidgets112Render) {
      ...
      dependency_4 = _aimpactAilearnApp061ModelGclassroom;
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.6.1/gclassroom-explorer",
          "multibundle": true
        },
        "type": "widget"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.6.1/gclassroom-explorer.widget');
      ims = new Map();
      /****************************
