      ...
      ims.set('./txt', {
        ...
        creator: function (require, exports) {
          exports.txt = {
            "actions": {
              "assign": "Assigner",
              "use": "Créer une version personnalisée",
              "continue": "Continuer",
              "test": "Démo"
            },
            "errors": {
            ...
            "filter": {
              "title": "Filtrer la communauté",
              "description": "Indiquez les caractéristiques du type de module d'apprentissage que vous recherchez"
            },
            "filters": {
              "audience": {
                "label": "Type de formation",
                "error": "Veuillez sélectionner le public",
                "select": "Tous les publics"
              },
              "level": {
                "label": "Niveau ou degré",
                "error": "Veuillez sélectionner un niveau",
                "select": "Tous les niveaux"
              },
              "languages": {
                "select": {
                  "label": "Langue",
            ...
            "empty": {
              "community": {
                "title": "Aucun module dans la communauté",
                "description": "Il n'y a pas de modules disponibles dans la communauté. Partagez vos modules avec la communauté et découvrez les modules d'autres auteurs !"
              }
            }
          };
        }
