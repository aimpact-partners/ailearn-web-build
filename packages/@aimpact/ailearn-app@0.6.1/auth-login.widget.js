System.register(["@beyond-js/widgets@1.1.2/render", "@beyond-js/kernel@0.1.14/bundle", "@beyond-js/kernel@0.1.14/styles", "@beyond-js/react-18-widgets@1.1.8/page", "@aimpact/ailearn-app@0.6.1/stores/base", "react@18.3.1", "@beyond-js/kernel@0.1.14/routing", "@aimpact/chat-sdk@1.5.5/session", "pragmate-ui@1.0.8/alert", "pragmate-ui@1.0.8/components", "pragmate-ui@1.0.8/image", "@aimpact/ailearn-app@0.6.1/model/wrapper", "@beyond-js/react-18-widgets@1.1.8/hooks", "framer-motion@10.18.0", "@aimpact/ailearn-app@0.6.1/components/ui", "@aimpact/ailearn-app@0.6.1/components/icons", "@beyond-js/kernel@0.1.14/core", "pragmate-ui@1.0.8/form"], function (_export, _context) {
  "use strict";
  ...
  return {
    ...
    execute: function () {
      ...
      ;
      __pkg.dependencies.update([['@beyond-js/widgets/render', dependency_0], ['@beyond-js/kernel/styles', dependency_2], ['@beyond-js/react-18-widgets/page', dependency_3], ['@aimpact/ailearn-app/stores/base', dependency_4], ['react', dependency_5], ['@beyond-js/kernel/routing', dependency_6], ['@aimpact/chat-sdk/session', dependency_7], ['pragmate-ui/alert', dependency_8], ['pragmate-ui/components', dependency_9], ['pragmate-ui/image', dependency_10], ['@aimpact/ailearn-app/model/wrapper', dependency_11], ['@beyond-js/react-18-widgets/hooks', dependency_12], ['framer-motion', dependency_13], ['@aimpact/ailearn-app/components/ui', dependency_14], ['@aimpact/ailearn-app/components/icons', dependency_15], ['@beyond-js/kernel/core', dependency_16], ['pragmate-ui/form', dependency_17]]);
