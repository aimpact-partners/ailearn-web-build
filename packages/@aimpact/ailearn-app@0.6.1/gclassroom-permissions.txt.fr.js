      ...
      *********************/
      ims.set('./txt', {
        ...
        creator: function (require, exports) {
          exports.txt = {
            "preTitle": "Liez votre compte avec",
            "title": "Google Classroom",
            "subtitle": "La nouvelle façon d'enseigner et d'apprendre avec l'Intelligence Artificielle",
            "instructions": "Nous devons lier votre compte avec Google Classroom afin de pouvoir assigner les travaux de cours que vous générez à vos salles de classe. Cliquez sur 'Lier maintenant' pour continuer.",
            "error": "Quelque chose s'est mal passé ! Veuillez contacter l'administrateur",
            "action": "Lier maintenant",
            "theme": "Mode %them",
            "ERROR_GETTING_URL": "Erreur lors de l'obtention de l'URL de Classroom"
          };
        }
      });
