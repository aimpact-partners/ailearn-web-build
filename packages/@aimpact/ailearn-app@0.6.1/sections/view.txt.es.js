        ...
        creator: function (require, exports) {
          exports.txt = {
            "coins": {
              ...
              "assignments": "Bases de Conocimiento",
              "modules": "Módulos"
            },
            "errors": {
            ...
            "forms": {
              ...
              "delete": {
                ...
                "description": "Recuerda que eliminar un usuario también elimina su acceso y acciones dentro de la sección."
              },
              "cancel": {
                "title": "¿Deseas cancelar la invitación del usuario?",
                "description": "Recuerda que cancelar la invitación del usuario también cancela su acceso y acciones dentro de la sección."
              },
              "reject": {
                "title": "¿Deseas rechazar la solicitud del usuario?",
                "description": "Recuerda que rechazar la solicitud del usuario también cancela su acceso y acciones dentro de la sección."
              },
              "edit": {
                "title": "¿Deseas cambiar el rol del usuario?",
                "info": "Recuerda que cambiar el rol también modifica el acceso y las acciones del usuario dentro de la sección."
              }
            },
            "editForm": {
              "title": "¿Deseas cambiar el rol del usuario?",
            ...
            "item": {
              "description": "La sección no tiene una descripción aún"
            },
            "roles": {
              "all": {
                "identifier": "all",
            ...
            "ERR_GENERATING_ACTIVITIES": "Error generando secciones",
            "messages": {
              "approval": {
            ...
            "not_member": {
              ...
              "description": "No tienes acceso a la sección, debes solicitarlo al docente y esperar a que él lo confirme",
            ...
            "orgCode": "Código de la sección",
            "title": "Agrega un titulo",
            "description": "Agrega una descripción",
            "people": "Personas",
            "viewAssignment": "Ver Bases de Conocimiento",
            "empty": {
              "assignments": {
                "title": "No hay bases de conocimiento disponibles"
              },
              "rol": {
