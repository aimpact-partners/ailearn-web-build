        ...
        creator: function (require, exports) {
          exports.txt = {
            "coins": {
              ...
              "assignments": "Bases de connaissances",
              "modules": "Modules"
            },
            "errors": {
            ...
            "forms": {
              "approve": {
                ...
                "description": "N'oubliez pas qu'approuver la demande de l'utilisateur modifie également son rôle et son accès dans la section."
              },
              "delete": {
                "title": "Voulez-vous supprimer l'utilisateur ?",
                "description": "N'oubliez pas que supprimer un utilisateur supprime également son accès et ses actions dans la section."
              },
              "cancel": {
                "title": "Voulez-vous annuler l'invitation de l'utilisateur ?",
                "description": "N'oubliez pas qu'annuler l'invitation de l'utilisateur annule également son accès et ses actions dans la section."
              },
              "reject": {
                "title": "Voulez-vous rejeter la demande de l'utilisateur ?",
                "description": "N'oubliez pas que rejeter la demande de l'utilisateur annule également son accès et ses actions dans la section."
              },
              "edit": {
                "title": "Voulez-vous changer le rôle de l'utilisateur ?",
                "info": "N'oubliez pas que changer le rôle modifie également l'accès et les actions de l'utilisateur dans la section."
              }
            },
            "editForm": {
              "title": "Voulez-vous changer le rôle de l'utilisateur ?",
            ...
            "item": {
              "description": "La section n'a pas encore de description"
            },
            "roles": {
              "all": {
                "identifier": "all",
            ...
            "ERR_GENERATING_ACTIVITIES": "Erreur lors de la génération des sections",
            "not_member": {
              "title": "Bonjour",
              "subtitle": "Il semble que vous n'ayez pas accès à",
              "description": "Vous n'avez pas accès à la section, vous devez le demander à l'enseignant et attendre qu'il confirme",
            ...
            "orgCode": "Code de la section",
            "title": "Ajouter un nom",
            "description": "Ajouter une description",
            "people": "Personnes",
            "viewAssignment": "Voir les bases de connaissances",
            "empty": {
              "assignments": {
                "title": "Aucune base de connaissances disponible"
              },
              "rol": {
