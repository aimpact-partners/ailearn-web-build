System.register(["@beyond-js/kernel@0.1.12/bundle", "@beyond-js/kernel@0.1.12/routing", "@beyond-js/kernel@0.1.12/core", "@aimpact/chat-sdk@1.4.4/config", "@beyond-js/reactive@2.0.4/model"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsKernel0112Bundle) {
      ...
      dependency_3 = _aimpactChatSdk144Config;
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/chat-sdk@1.4.4/voice"
        },
        "type": "ts"
