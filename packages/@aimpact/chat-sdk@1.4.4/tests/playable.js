System.register(["@beyond-js/widgets@1.1.2/render", "@beyond-js/kernel@0.1.12/bundle", "@beyond-js/react-18-widgets@1.1.4/page", "react@18.3.1", "@aimpact/chat-sdk@1.4.4/widgets/playable", "@aimpact/chat-sdk@1.4.4/voice"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsWidgets112Render) {
      ...
      dependency_4 = _aimpactChatSdk144WidgetsPlayable;
    }, function (_aimpactChatSdk144Voice) {
      dependency_5 = _aimpactChatSdk144Voice;
    }],
    execute: function () {
      bimport = specifier => {
