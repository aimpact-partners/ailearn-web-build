System.register(["@beyond-js/kernel@0.1.9/bundle", "@beyond-js/kernel@0.1.9/core", "@aimpact/ailearn-app@0.0.24/config", "@beyond-js/reactive@1.1.11/model"], function (_export, _context) {
  "use strict";
