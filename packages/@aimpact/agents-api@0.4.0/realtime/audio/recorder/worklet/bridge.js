System.register(["@beyond-js/kernel@0.1.9/bundle", "@aimpact/agents-api@0.4.0/realtime/audio/worklet-bridge"], function (_export, _context) {
  "use strict";
  ...
  return {
    ...
    }, function (_aimpactAgentsApi040RealtimeAudioWorkletBridge) {
      dependency_1 = _aimpactAgentsApi040RealtimeAudioWorkletBridge;
    }],
    execute: function () {
      bimport = specifier => {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/agents-api@0.4.0/realtime/audio/recorder/worklet/bridge"
        },
        "type": "ts"
