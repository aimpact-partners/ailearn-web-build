System.register(["@beyond-js/kernel@0.1.9/bundle", "@aimpact/agents-api@0.4.0/realtime/audio/player/worklet/bridge", "@aimpact/agents-api@0.4.0/realtime/audio/player/analyzer"], function (_export, _context) {
  "use strict";
  ...
  return {
    ...
    }, function (_aimpactAgentsApi040RealtimeAudioPlayerWorkletBridge) {
      dependency_1 = _aimpactAgentsApi040RealtimeAudioPlayerWorkletBridge;
    }, function (_aimpactAgentsApi040RealtimeAudioPlayerAnalyzer) {
      dependency_2 = _aimpactAgentsApi040RealtimeAudioPlayerAnalyzer;
    }],
    execute: function () {
      bimport = specifier => {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/agents-api@0.4.0/realtime/audio/player"
        },
        "type": "ts"
