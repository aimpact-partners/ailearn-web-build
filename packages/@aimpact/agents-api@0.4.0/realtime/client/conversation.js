System.register(["@beyond-js/kernel@0.1.9/bundle", "@aimpact/agents-api@0.4.0/realtime/utils", "@beyond-js/events@0.0.7/events"], function (_export, _context) {
  "use strict";
  ...
  return {
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/agents-api@0.4.0/realtime/client/conversation"
        },
        "type": "ts"
