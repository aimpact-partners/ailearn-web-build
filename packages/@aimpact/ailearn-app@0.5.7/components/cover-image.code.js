System.register(["@beyond-js/kernel@0.1.12/bundle", "@aimpact/ailearn-app@0.5.7/components/icons", "react@18.3.1", "pragmate-ui@1.0.6/components", "pragmate-ui@1.0.6/icons", "@aimpact/ailearn-app@0.5.7/main-layout.widget", "pragmate-ui@1.0.6/image", "pragmate-ui@1.0.6/modal", "pragmate-ui@1.0.6/alert", "@aimpact/ailearn-app@0.5.7/components/ui", "@aimpact/ailearn-app@0.5.7/modules/management/refinament.code", "@beyond-js/react-18-widgets@1.1.4/hooks", "@beyond-js/kernel@0.1.12/styles"], function (_export, _context2) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsKernel0112Bundle) {
      ...
      dependency_1 = _aimpactAilearnApp057ComponentsIcons;
    }, function (_react2) {
    ...
    execute: function () {
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.5.7/components/cover-image.code');
      ims = new Map();
      /*************************
