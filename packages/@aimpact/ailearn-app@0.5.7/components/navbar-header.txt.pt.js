        ...
        creator: function (require, exports) {
          exports.txt = {
            "menu": {
              ...
              "classworks": "Trabalhos da Sala",
              "chat": "Chat",
              "organizations": "Instituições",
              "archive": "Arquivo",
              "support": "Suporte",
              "knowledgeBoxes": "Base de Conhecimento",
              "sections": "Seções",
              "articles": "Artigos"
            },
            "userMenu": {
            ...
            "newVersion": {
              "xs": "Conheça as novas funcionalidades do RVD.ai",
              "desktop": {
                "title": "Você está navegando uma nova versão do AILearn.",
                "label": "Conheça todas as melhorias que realizamos dentro da nossa plataforma seguindo ",
                "link": "este link"
              }
            }
          };
