System.register(["@beyond-js/kernel@0.1.12/bundle", "@beyond-js/reactive@2.1.1/model", "@aimpact/ailearn-app@0.5.7/model/wrapper", "@beyond-js/http-suite@0.1.1/api", "@beyond-js/kernel@0.1.12/core", "@aimpact/ailearn-app@0.5.7/config", "dayjs@1.11.13", "@aimpact/chat-sdk@1.5.5/session"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsKernel0112Bundle) {
      ...
      dependency_2 = _aimpactAilearnApp057ModelWrapper;
      ...
      dependency_5 = _aimpactAilearnApp057Config;
    }, function (_dayjs2) {
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.5.7/model/gclassroom"
        },
        "type": "ts"
