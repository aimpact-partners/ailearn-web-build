System.register(["@beyond-js/widgets@1.1.2/render", "@beyond-js/kernel@0.1.12/bundle", "@beyond-js/kernel@0.1.12/styles", "@beyond-js/react-18-widgets@1.1.4/base", "@beyond-js/reactive@2.1.1/model", "@beyond-js/widgets@1.1.2/controller", "react@18.3.1", "pragmate-ui@1.0.6/breadcrumb", "pragmate-ui@1.0.6/base", "@beyond-js/react-18-widgets@1.1.4/hooks", "@beyond-js/kernel@0.1.12/routing"], function (_export, _context) {
  "use strict";
  ...
  return {
    ...
    }, function (_pragmateUi106Breadcrumb) {
      dependency_7 = _pragmateUi106Breadcrumb;
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.5.7/widgets/breadcrumb",
          "multibundle": true
        },
        "type": "widget"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.5.7/widgets/breadcrumb.widget');
      ims = new Map();
      /****************************
