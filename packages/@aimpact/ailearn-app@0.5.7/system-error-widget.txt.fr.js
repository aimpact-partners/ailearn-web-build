      ...
      *********************/
      ims.set('./txt', {
        ...
        creator: function (require, exports) {
          exports.txt = {
            "title": "Oups ! Il semble que vous soyez tombé sur un territoire inexploré.",
            "description": "Il semble que vous ayez emprunté un chemin numérique inexploré. Notre carte a temporairement disparu, mais ne vous inquiétez pas, nos ingénieurs travaillent à rétablir le signal. En attendant, n'hésitez pas à revenir au point de départ ou à explorer d'autres routes numériques depuis notre page d'accueil. À l'ère de l'information, chaque clic est une opportunité de découverte.",
            "conclusion": "Bonne chance dans votre voyage !"
          };
        }
      });
