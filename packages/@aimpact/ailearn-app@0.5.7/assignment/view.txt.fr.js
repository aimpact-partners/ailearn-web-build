      ...
      ims.set('./txt', {
        ...
        creator: function (require, exports) {
          exports.txt = {
            ...
            "not_member": {
              "title": "Bonjour",
              "subtitle": "Il semble que vous n'ayez pas encore accès à",
            ...
            "invited": {
              ...
              "description": "Commencez votre expérience d'apprentissage assistée par IA, explorez du contenu conçu spécialement pour vous en participant à des activités interactives à votre propre rythme et selon votre style d'apprentissage.",
              "action": "Accéder"
            },
            "pending": {
              "title": "Bonjour",
            ...
            "empty": "Vous n'avez pas encore de travaux de classe",
            "access": "Accéder",
            "description": "Ici vous trouverez les Modules d'apprentissage que votre enseignant partagera avec vous afin de travailler sur les objectifs curriculaires. Entrez dans les différentes salles de classe et amusez-vous en apprenant avec votre tuteur.",
            "dividerTitle": "Activités",
            "textCounter": "Activité ",
            "moduleSubtitleText": "Activités",
            "accessed": "Vous pouvez maintenant accéder aux activités",
            "moduleAccess": "Accès"
          };
        }
      });
