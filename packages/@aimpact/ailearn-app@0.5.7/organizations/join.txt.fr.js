        ...
        creator: function (require, exports) {
          exports.txt = {
            ...
            "breadcrumb": {
              ...
              "management": "créer",
              "join": "Rejoindre une institution"
            },
            "errors": {
            ...
            "describe": "Rejoignez une organisation pour accéder au contenu et participer à des activités éducatives.",
            "form": {
              "title": "Code de l'organisation",
              "subtitle": "Entrez le code fourni par l'administrateur de l'organisation",
              "placeholder": "Code de l'organisation"
            },
            "info": {
              "title": "Comment rejoindre avec un code valide",
              "help": "Si vous avez des difficultés à rejoindre, consultez l'administrateur de l'organisation"
            },
            "member": {
              "title": "Vous êtes déjà membre de l'organisation",
              "action": "Aller à l'organisation"
            },
            "ready": {
              "title": "Demande envoyée",
              "description": "Maintenant vous devez attendre l'approbation de l'administrateur et ensuite vous pourrez avoir accès"
            },
            "messages": {
              "success": "Vous avez rejoint l'organisation !",
