System.register(["@beyond-js/kernel@0.1.12/bundle"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.5.7/modules/management/overview",
          "multibundle": true
        },
        "type": "txt"
          ...
          exports.txt = {
            ...
            "activities": {
              ...
              "types": {
                ...
                "hand-written": "Manuelle Aktivität",
                "written": "Schriftliche Aktivität",
              ...
              "descriptionTypes": {
                "content-theory": "Theoretische Inhalte durch geführte Erklärungen und Beispiele lernen und verstehen.",
                "multiple-choice": "Beantwortung von Multiple-Choice-Fragen zur Überprüfung des Verständnisses.",
                "character-talk": "Lernen durch ein geführtes Gespräch mit einer fiktiven Figur zur Erkundung eines Themas oder einer Perspektive.",
                "debate": "Argumentieren und Verteidigen einer Position in einem Einzelgespräch mit einem virtuellen Assistenten.",
                "spoken": "Mündliche Präsentation zu einem zugewiesenen Thema, um Wissen, Kreativität oder Originalität zu zeigen.",
                "free-conversation": "Flexible Aktivität, bei der der Schüler über eine vom Lehrer gestellte Aufgabe berichtet, erklärt oder reflektiert.",
                "hand-written": "Vielseitige Aktivität, bei der der Schüler ein Foto einer handschriftlichen Arbeit hochlädt.",
                "written": "Vielseitige Aktivität, bei der der Schüler einen Text zu einem beliebigen Thema schreibt und einreicht.",
                "exercise": "Schrittweise Bearbeitung einer konkreten Aufgabe, geführt durch ein Gespräch mit dem Assistenten."
              },
              "states": {
