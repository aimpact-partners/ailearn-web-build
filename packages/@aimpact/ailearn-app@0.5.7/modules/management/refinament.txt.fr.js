      ...
      ims.set('./txt', {
        ...
        creator: function (require, exports) {
          exports.txt = {
            ...
            "errors": {
              "200": "L'objectif de l'activité est obligatoire",
              "NO_RELATED_ACTIVITY": "L'activité liée n'a pas encore de contenu, il est nécessaire de générer le contenu avant de l'utiliser",
              "default": "Une erreur s'est produite, veuillez réessayer"
            },
            "activity": {
              "title": "Générer l'activité avec IA",
              "description": "Nous allons générer l'activité basée sur l'objectif suivant"
            },
            "error": "Veuillez ajouter des notes détaillées pour la génération",
            "textarea": {
