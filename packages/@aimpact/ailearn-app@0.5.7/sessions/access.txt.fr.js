      ...
      *********************/
      ims.set('./txt', {
        ...
        creator: function (require, exports) {
          exports.txt = {
            "welcome": "Bienvenue sur AI-Learn",
            "shared": "a été partagé avec vous.",
            "action": "Commencer le cours",
            "save": "Sauvegardez le cours et commencez à apprendre.",
            "accessed": "Allez dans les chats de votre cours et continuez à apprendre",
            "empty": {
              "welcome": "Oups !",
              "info": "Nous n'avons pas pu trouver le cours.",
              "action": "Veuillez vérifier le lien."
            }
          };
        }
      });
