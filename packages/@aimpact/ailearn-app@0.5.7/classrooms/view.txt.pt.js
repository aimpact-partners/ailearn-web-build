          ...
          exports.txt = {
            ...
            "forms": {
              "approve": {
                ...
                "description": "Lembre-se de que aprovar a solicitação do usuário também modifica sua função e acesso dentro da sala de aula."
              },
              "delete": {
                "title": "Deseja excluir o usuário?",
                "description": "Lembre-se de que excluir um usuário também exclui seu acesso e ações dentro da sala de aula."
              },
              "cancel": {
                "title": "Deseja cancelar o convite do usuário?",
                "description": "Lembre-se de que cancelar o convite do usuário também cancela seu acesso e ações dentro da sala de aula."
              },
              "reject": {
                "title": "Deseja rejeitar a solicitação do usuário?",
                "description": "Lembre-se de que rejeitar a solicitação do usuário também cancela seu acesso e ações dentro da sala de aula."
              },
              "edit": {
                "title": "Deseja alterar a função do usuário?",
                "info": "Lembre-se de que alterar a função também modifica o acesso e as ações do usuário dentro da sala de aula."
              }
            },
            "editForm": {
              "title": "Deseja alterar a função do usuário?",
            ...
            "orgCode": "Código da Sala de Aula",
            "title": "Adicionar um nome",
            "description": "Adicionar uma descrição",
            "people": "Pessoas",
            "viewAssignment": "Ver Atribuição",
            "empty": {
              "assignments": {
                "title": "Nenhuma atribuição disponível"
              },
              "rol": {
