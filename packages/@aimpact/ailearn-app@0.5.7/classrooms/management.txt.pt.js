      ...
      ims.set('./txt', {
        ...
        creator: function (require, exports) {
          exports.txt = {
            ...
            "errors": {
              "default": "A sala de aula não pôde ser registrada. Por favor, valide os dados e tente novamente"
            },
            "institution": {
              "label": "Instituição",
              "select": "Selecionar instituição",
              "own": "Não pertence a uma instituição"
            }
          };
        }
      });
