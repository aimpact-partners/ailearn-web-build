System.register(["@beyond-js/widgets@1.1.2/render", "@beyond-js/kernel@0.1.12/bundle", "@beyond-js/kernel@0.1.12/styles", "@beyond-js/react-18-widgets@1.1.4/page", "@aimpact/ailearn-app@0.5.7/main-layout.widget", "@aimpact/ailearn-app@0.5.7/stores/base", "@aimpact/ailearn-sdk@1.2.0/entities/sections", "react@18.3.1", "pragmate-ui@1.0.6/modal", "pragmate-ui@1.0.6/components", "@aimpact/ailearn-app@0.5.7/components/ui", "@aimpact/ailearn-app@0.5.7/shared/hooks", "pragmate-ui@1.0.6/icons", "@aimpact/ailearn-app@0.5.7/components/icons", "pragmate-ui@1.0.6/dropdown", "@beyond-js/react-18-widgets@1.1.4/hooks", "@aimpact/ailearn-app@0.5.7/components/module-card", "pragmate-ui@1.0.6/list"], function (_export, _context2) {
  ...
  return {
    setters: [function (_beyondJsWidgets112Render) {
      ...
      dependency_13 = _aimpactAilearnApp057ComponentsIcons;
    }, function (_pragmateUi106Dropdown) {
      dependency_14 = _pragmateUi106Dropdown;
    }, function (_beyondJsReact18Widgets114Hooks) {
      dependency_15 = _beyondJsReact18Widgets114Hooks;
    }, function (_aimpactAilearnApp057ComponentsModuleCard) {
      dependency_16 = _aimpactAilearnApp057ComponentsModuleCard;
    }, function (_pragmateUi106List) {
      dependency_17 = _pragmateUi106List;
    }],
    execute: function () {
      bimport = specifier => {
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.5.7/sections/list.widget');
      ims = new Map();
      /****************************
