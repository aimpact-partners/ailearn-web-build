      ...
      *********************/
      ims.set('./txt', {
        ...
        creator: function (require, exports) {
          exports.txt = {
            "title": "Ops! Parece que você tropeçou em um território desconhecido.",
            "description": "Parece que você se aventurou por um caminho digital inexplorado. Nosso mapa se perdeu temporariamente, mas não se preocupe, nossos engenheiros estão trabalhando para restaurar o sinal. Enquanto isso, sinta-se livre para retornar ao ponto de partida ou explorar outras rotas digitais a partir da nossa página inicial. Na era da informação, cada clique é uma oportunidade de descoberta.",
            "conclusion": "Boa sorte na sua jornada!"
          };
        }
      });
