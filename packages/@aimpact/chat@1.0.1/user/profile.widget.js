System.register(["@beyond-js/widgets@0.1.5/render", "@beyond-js/kernel@0.1.9/bundle", "@beyond-js/kernel@0.1.9/styles", "react@18.2.0", "@beyond-js/react-18-widgets@1.0.1/base", "@beyond-js/kernel@0.1.9/core", "@beyond-js/reactive@1.1.6/model", "@aimpact/chat@1.0.1/wrapper", "@beyond-js/react-18-widgets@1.0.1/hooks", "pragmate-ui@0.0.1/components", "@aimpact/chat-sdk@1.0.0/session", "pragmate-ui@0.0.1/form", "pragmate-ui@0.0.1/toast"], function (_export, _context2) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsWidgets015Render) {
      ...
      dependency_12 = _pragmateUi001Toast;
    }],
    execute: function () {
      bimport = specifier => {
