System.register(["@beyond-js/kernel@0.1.9/bundle","react@18.2.0","pragmate-ui@0.1.1/icons","pragmate-ui@0.1.1/components"],function(o,a){"use strict";var t,r,i,l,e,n;return o({ICONS:void 0,AppIcon:void 0,AppIconButton:void 0,AppButton:void 0}),{setters:[function(a){t=a},function(a){r=a},function(a){i=a},function(a){l=a}],execute:function(){n=t.Bundle,(e=new n({module:{vspecifier:"@aimpact/chat@1.0.1/components/icons"},type:"code"},a.meta.url).package()).dependencies.update([["react",r],["pragmate-ui/icons",i],["pragmate-ui/components",l]]),(n=new Map).set("./icons",{hash:2765742218,creator:function(a,t){Object.defineProperty(t,"__esModule",{value:!0}),t.ICONS=void 0;t.ICONS={"aip-chat-logo":{viewBox:"0 0 137.637 36",icon:`<defs>
  ...
  <g id="Grupo_47"  transform="translate(-0.001)">
    <g id="Grupo_119" >
  ...
  </g>`},logo:{viewBox:"0 0 35.976 39.035",icon:`<g> <defs>
		<linearGradient id="linear-gradient" x1="-0.109" y1="0.256" x2="0.989" y2="0.558" gradientUnits="objectBoundingBox">
		  <stop offset="0" stop-color="#115efa"/>
		  <stop offset="0.058" stop-color="#1461fa"/>
		  <stop offset="0.209" stop-color="#1c67fa"/>
	  ...
	  </g></g>`},"icon-menu":{viewBox:"0 0 24 24",icon:'<g><path id="Trazado_154" data-name="Trazado 154" d="M0,0H24V24H0Z" fill="none"/><path id="Trazado_158" data-name="Trazado 158" d="M3,18H16V16H3Zm0-5H13V11H3ZM3,6V8H16V6Zm18,9.59L17.42,12,21,8.41,19.59,7l-5,5,5,5Z"/></g>'},"ai-profile":{viewBox:"0 0 38 38",icon:`<g> <defs>
    <linearGradient id="linear-gradient" x1="-0.109" y1="0.256" x2="0.989" y2="0.558" gradientUnits="objectBoundingBox">
      <stop offset="0" stop-color="#115efa"/>
      <stop offset="0.058" stop-color="#1461fa"/>
      <stop offset="0.209" stop-color="#1c67fa"/>
