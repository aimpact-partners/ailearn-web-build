System.register(["@beyond-js/kernel@0.1.9/bundle", "@beyond-js/reactive@1.1.6/model", "@aimpact/chat@1.0.1/api", "@aimpact/chat-sdk@1.0.0/session", "@aimpact/ailearn-app@0.0.15/config"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsKernel019Bundle) {
      ...
      dependency_4 = _aimpactAilearnApp0015Config;
    }],
    execute: function () {
      bimport = specifier => {
