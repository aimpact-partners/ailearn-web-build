System.register(["@beyond-js/widgets@1.1.2/render", "@beyond-js/kernel@0.1.12/bundle", "@beyond-js/kernel@0.1.12/styles", "@beyond-js/react-18-widgets@1.1.4/page", "@aimpact/ailearn-sdk@1.2.0/entities/organizations", "@beyond-js/reactive@2.0.5/model", "@aimpact/chat-sdk@1.5.4/session", "@aimpact/ailearn-app@0.4.1/main-layout.widget", "@beyond-js/kernel@0.1.12/texts", "react@18.3.1", "pragmate-ui@1.0.0-beta.7/form", "pragmate-ui@1.0.0-beta.7/components", "@aimpact/ailearn-app@0.4.1/components/ui", "@beyond-js/react-18-widgets@1.1.4/hooks", "pragmate-ui@1.0.0-beta.7/toast", "@beyond-js/kernel@0.1.12/routing"], function (_export, _context2) {
  ...
  return {
    setters: [function (_beyondJsWidgets112Render) {
      ...
      dependency_7 = _aimpactAilearnApp041MainLayoutWidget;
    ...
    execute: function () {
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.4.1/organizations/management.widget');
      ims = new Map();
      /****************************
