System.register(["@beyond-js/kernel@0.1.9/bundle", "@beyond-js/reactive@1.1.2/model", "@aimpact/chat@0.0.2/api", "@aimpact/chat@0.0.2/session", "@aimpact/ailearn-app@0.0.1/config"], function (_export, _context) {
  "use strict";
  ...
  return {
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/chat@0.0.2/models/documents"
        },
        "type": "ts"
      }, _context.meta.url).package();
      ;
      __pkg.dependencies.update([['@beyond-js/reactive/model', dependency_1], ['@aimpact/chat/api', dependency_2], ['@aimpact/chat/session', dependency_3], ['@aimpact/chat/config', dependency_4]]);
      ims = new Map();
      /***********************
