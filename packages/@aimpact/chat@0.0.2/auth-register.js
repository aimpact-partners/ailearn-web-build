System.register(["@beyond-js/widgets@0.1.5/render", "@beyond-js/kernel@0.1.9/bundle", "@beyond-js/kernel@0.1.9/styles", "@beyond-js/react-18-widgets@1.0.1/page", "react@18.2.0", "@beyond-js/kernel@0.1.9/routing", "pragmate-ui@0.0.36/form", "pragmate-ui@0.0.36/link", "pragmate-ui@0.0.36/icons", "pragmate-ui@0.0.36/alert", "@aimpact/chat@0.0.2/shared/icons", "@aimpact/chat@0.0.2/shared/components", "@aimpact/chat-sdk@0.0.1/session"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsWidgets015Render) {
      ...
      dependency_12 = _aimpactChatSdk001Session;
    }],
    execute: function () {
      bimport = specifier => {
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/chat@0.0.2/auth-register');
      ims = new Map();
      /****************************
