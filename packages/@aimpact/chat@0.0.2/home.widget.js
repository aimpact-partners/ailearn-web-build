System.register(["@beyond-js/widgets@0.1.4/render", "@beyond-js/kernel@0.1.9/bundle", "@beyond-js/kernel@0.1.9/styles", "@beyond-js/react-18-widgets@0.0.6/page", "react@18.2.0", "pragmate-ui@0.0.36/icons", "pragmate-ui@0.0.36/form", "@beyond-js/kernel@0.1.9/routing", "@aimpact/chat@0.0.2/ui/manager", "@aimpact/chat@0.0.2/wrapper"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsWidgets014Render) {
      ...
      dependency_8 = _aimpactChat002UiManager;
    }, function (_aimpactChat002Wrapper) {
      dependency_9 = _aimpactChat002Wrapper;
    }],
    execute: function () {
      bimport = specifier => {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/chat@0.0.2/home",
          "multibundle": true
        },
        "type": "widget"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/chat@0.0.2/home.widget');
      ims = new Map();
      /****************************
