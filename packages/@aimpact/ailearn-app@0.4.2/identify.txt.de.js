          ...
          exports.txt = {
            ...
            "student": {
              "selection": {
                ...
                "description": "Um Ihre Lernerfahrung mit RVD.AI zu beginnen, können Sie den Lehrer nach dem Zugangscode für den Klassenraum fragen und diesen eingeben, um fortzufahren, oder den Zugangslink zu einer Aktivität anfordern. Sobald Sie diese Informationen haben, können Sie das Lernmodul betreten und mit der Erkundung der speziell für Sie entwickelten Inhalte beginnen."
              },
              "form": {
                "title": "Beginnen Sie Ihre Bildungstransformation",
                "description": "Sie sind dabei, dem Bildungsraum Ihrer Institution beizutreten. Um RVD.AI zu betreten, müssen Sie den vom Administrator Ihrer Institution bereitgestellten Zugangscode validieren.",
                "form": {
                  "legend": {
            ...
            "teacher": {
              ...
              "institution": {
                "intro": {
                  ...
                  "options": {
                    "yes": {
                      "label": "Ja",
                      "description": "Meine Institution arbeitet bereits mit <strong>RVD.AI</strong> und ich möchte ihrem Bildungsraum beitreten."
                    },
                    "no": {
                      "label": "Nein",
                      "description": "Meine Institution arbeitet nicht mit <strong>RVD.AI</strong>. Ich möchte dem Tool als unabhängiger Lehrer beitreten."
                    }
                  }
                },
                "form": {
                  "title": "Beginnen Sie die Bildungstransformation",
                  "description": "Sie sind dabei, dem Bildungsraum Ihrer Institution beizutreten. Um auf RVD.AI zuzugreifen, müssen Sie den vom Administrator Ihrer Institution bereitgestellten Zugangscode validieren.",
                  "form": {
                    "legend": {
              ...
              "welcome": {
                "user": {
                  "hello": "Hallo {username}!",
                  "description": "Willkommen bei RVD.AI"
                }
              },
              "processed": {
