              ...
              "institution": {
                "intro": {
                  ...
                  "options": {
                    "yes": {
                      "label": "Yes",
                      "description": "My institution already works with <strong>RVD.AI</strong> and I want to join its educational space."
                    },
                    "no": {
                      "label": "No",
                      "description": "My institution does not work with <strong>RVD.AI</strong>. I want to join the tool as an independent teacher."
                    }
                  }
                },
                "form": {
                  "title": "Start the educational transformation",
                  "description": "You are about to join your institution's educational space. To access RVD.AI, you must validate the access code provided by your institution's administrator.",
                  "form": {
                    "legend": {
