System.register(["@beyond-js/widgets@1.1.2/render", "@beyond-js/kernel@0.1.12/bundle", "@beyond-js/kernel@0.1.12/styles", "@beyond-js/react-18-widgets@1.1.4/page", "@aimpact/ailearn-app@0.4.2/stores/base", "react@18.3.1", "@beyond-js/kernel@0.1.12/routing", "@aimpact/chat-sdk@1.5.4/session", "pragmate-ui@1.0.2/alert", "pragmate-ui@1.0.2/components", "pragmate-ui@1.0.2/image", "@aimpact/ailearn-app@0.4.2/model/wrapper", "@beyond-js/react-18-widgets@1.1.4/hooks", "framer-motion@10.18.0", "@aimpact/ailearn-app@0.4.2/components/ui", "@beyond-js/kernel@0.1.12/core", "pragmate-ui@1.0.2/form"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsWidgets112Render) {
      ...
      dependency_9 = _pragmateUi102Components;
      ...
      dependency_16 = _pragmateUi102Form;
    }],
    execute: function () {
      bimport = specifier => {
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.4.2/auth-login.widget');
      ims = new Map();
      /****************************
