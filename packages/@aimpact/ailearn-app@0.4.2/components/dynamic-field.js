System.register(["@beyond-js/kernel@0.1.12/bundle", "react@18.3.1", "pragmate-ui@1.0.2/components", "pragmate-ui@1.0.2/icons", "pragmate-ui@1.0.2/base", "lodash@4.17.21", "@beyond-js/kernel@0.1.12/styles"], function (_export, _context2) {
  "use strict";
  ...
  return {
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.4.2/components/dynamic-field"
        },
        "type": "code"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.4.2/components/dynamic-field');
      ims = new Map();
      /*****************************
