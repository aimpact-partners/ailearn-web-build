System.register(["@beyond-js/kernel@0.1.12/bundle", "@aimpact/ailearn-app@0.4.2/components/icons", "react@18.3.1", "pragmate-ui@1.0.2/components", "pragmate-ui@1.0.2/icons", "@aimpact/ailearn-app@0.4.2/main-layout.widget", "pragmate-ui@1.0.2/image", "pragmate-ui@1.0.2/modal", "pragmate-ui@1.0.2/alert", "@aimpact/ailearn-app@0.4.2/components/ui", "@aimpact/ailearn-app@0.4.2/modules/management/refinament.code", "@beyond-js/react-18-widgets@1.1.4/hooks", "@beyond-js/kernel@0.1.12/styles"], function (_export, _context2) {
  "use strict";
  ...
  return {
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.4.2/components/cover-image",
          "multibundle": true
        },
        "type": "code"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.4.2/components/cover-image.code');
      ims = new Map();
      /*************************
