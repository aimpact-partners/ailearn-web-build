System.register(["@beyond-js/widgets@1.1.2/render", "@beyond-js/kernel@0.1.12/bundle", "@beyond-js/react-18-widgets@1.1.4/base", "@beyond-js/reactive@2.0.5/model", "react@18.3.1", "@beyond-js/react-18-widgets@1.1.4/hooks", "@beyond-js/kernel@0.1.12/styles"], function (_export, _context) {
  "use strict";
  ...
  return {
    ...
    execute: function () {
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.4.2/auth-layout');
      ims = new Map();
      /****************************
