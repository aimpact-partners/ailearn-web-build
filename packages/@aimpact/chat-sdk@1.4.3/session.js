System.register(["@beyond-js/kernel@0.1.12/bundle", "@beyond-js/reactive@1.2.0-beta.01/model", "@aimpact/chat-sdk@1.4.3/users", "@beyond-js/kernel@0.1.12/core", "firebase@10.14.1/auth", "@aimpact/chat-sdk@1.4.3/config", "firebase@10.14.1/analytics", "firebase@10.14.1/app"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsKernel0112Bundle) {
      ...
      dependency_2 = _aimpactChatSdk143Users;
      ...
      dependency_5 = _aimpactChatSdk143Config;
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/chat-sdk@1.4.3/session"
        },
        "type": "ts"
