System.register(["@beyond-js/kernel@0.1.12/bundle", "@aimpact/chat-sdk@1.4.3/startup", "@beyond-js/reactive@1.2.0-beta.01/entities/item", "@beyond-js/kernel@0.1.12/core", "firebase@10.14.1/auth", "@beyond-js/http-suite@0.0.1/api", "@aimpact/chat-sdk@1.4.3/config"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsKernel0112Bundle) {
      ...
      dependency_1 = _aimpactChatSdk143Startup;
    }, function (_beyondJsReactive120Beta01EntitiesItem) {
      dependency_2 = _beyondJsReactive120Beta01EntitiesItem;
      ...
      dependency_6 = _aimpactChatSdk143Config;
    }],
    execute: function () {
      bimport = specifier => {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/chat-sdk@1.4.3/users"
        },
        "type": "ts"
