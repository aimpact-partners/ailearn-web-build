System.register(["@beyond-js/kernel@0.1.12/bundle", "@beyond-js/kernel@0.1.12/routing", "@beyond-js/kernel@0.1.12/core", "@aimpact/chat-sdk@1.4.3/config", "@beyond-js/reactive@1.2.0-beta.01/model"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsKernel0112Bundle) {
      ...
      dependency_3 = _aimpactChatSdk143Config;
    }, function (_beyondJsReactive120Beta01Model) {
      dependency_4 = _beyondJsReactive120Beta01Model;
    }],
    execute: function () {
      bimport = specifier => {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/chat-sdk@1.4.3/voice"
        },
        "type": "ts"
