System.register(["@beyond-js/kernel@0.1.12/bundle", "@beyond-js/kernel@0.1.12/styles", "react@18.3.1", "@aimpact/chat-sdk@1.4.3/widgets/markdown", "@beyond-js/react-18-widgets@1.1.4/hooks"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsKernel0112Bundle) {
      ...
      dependency_3 = _aimpactChatSdk143WidgetsMarkdown;
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/chat-sdk@1.4.3/chat/messages/item"
        },
        "type": "code"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/chat-sdk@1.4.3/chat/messages/item');
      ims = new Map();
      /***********************
