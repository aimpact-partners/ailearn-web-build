System.register(["@beyond-js/kernel@0.1.12/bundle", "@aimpact/chat-sdk@1.4.3/core", "@aimpact/chat-sdk@1.4.3/session", "@beyond-js/reactive@1.2.0-beta.01/model", "@beyond-js/kernel@0.1.12/core"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsKernel0112Bundle) {
      ...
      dependency_1 = _aimpactChatSdk143Core;
    }, function (_aimpactChatSdk143Session) {
      dependency_2 = _aimpactChatSdk143Session;
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/chat-sdk@1.4.3/wrapper"
        },
        "type": "ts"
