System.register(["@beyond-js/widgets@1.1.3/render", "@beyond-js/kernel@0.1.12/bundle", "@beyond-js/react-18-widgets@1.1.4/page", "react@18.3.1", "@aimpact/chat-sdk@1.4.3/widgets/playable", "@aimpact/chat-sdk@1.4.3/voice"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsWidgets113Render) {
      ...
      dependency_4 = _aimpactChatSdk143WidgetsPlayable;
    }, function (_aimpactChatSdk143Voice) {
      dependency_5 = _aimpactChatSdk143Voice;
    }],
    execute: function () {
      bimport = specifier => {
