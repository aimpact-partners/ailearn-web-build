        ...
        creator: function (require, exports) {
          exports.txt = {
            ...
            "activities": {
              ...
              "empty": {
                "synthesis": "The activity does not have a synthesis",
                "content": "The activity does not have content"
              }
            },
            "breadcrumb": {
              "groups": {
            ...
            "errors": {
              ...
              "NO_CREDITS": "You don't have enough credits to perform this action",
              "DEFAULT_ERROR": "An error occurred, please try again later",
              "NO_ENOUGH_CONTEXT": "The provided context isn't enough to generate the image. Please add more descriptive details. For example: 'A futuristic city at sunset with flying cars and neon lights'.",
              "NO_IMAGE_GENERATED": "We couldn't process your request. Please try again."
            },
            "languages": {
              "es": {
                "code": "es",
            ...
            "requestCredits": {
              "title": "Enable AI",
              "subtitle": {
                "user": "Would you like to use a credit to enable AI functions for module generation?",
                "org": "You are an instructor authorized by {institution} to use AI credits for generating modules. Please confirm the use of one credit to enable AI in this learning module.",
                "interactive": "Would you like to use a credit to enable AI functions?"
              },
