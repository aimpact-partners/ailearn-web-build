System.register(["@beyond-js/widgets@1.1.1/render", "@beyond-js/kernel@0.1.9/bundle", "@beyond-js/react-18-widgets@1.1.2/page", "react@18.2.0", "@aimpact/chat-sdk@1.4.1/widgets/playable", "@aimpact/chat-sdk@1.4.1/voice"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsWidgets111Render) {
      ...
      dependency_4 = _aimpactChatSdk141WidgetsPlayable;
    }, function (_aimpactChatSdk141Voice) {
      dependency_5 = _aimpactChatSdk141Voice;
    }],
    execute: function () {
      bimport = specifier => {
