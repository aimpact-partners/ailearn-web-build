System.register(["@beyond-js/kernel@0.1.12/bundle", "react@18.3.1", "pragmate-ui@1.0.6/base", "pragmate-ui@1.0.6/icons", "@beyond-js/kernel@0.1.12/styles"], function (_export, _context2) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsKernel0112Bundle) {
      ...
      dependency_2 = _pragmateUi106Base;
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "pragmate-ui@1.0.6/form"
        },
        "type": "code",
        "name": "form"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('pragmate-ui@1.0.6/form');
      ims = new Map();
      /********************************
