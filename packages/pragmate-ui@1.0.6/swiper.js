System.register(["@beyond-js/kernel@0.1.12/bundle", "react@18.3.1", "pragmate-ui@1.0.6/icons", "swiper@10.3.1", "swiper@10.3.1/modules", "@beyond-js/reactive@2.1.1/model", "@beyond-js/kernel@0.1.12/styles"], function (_export, _context2) {
  "use strict";
  ...
  return {
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "pragmate-ui@1.0.6/swiper"
        },
        "type": "code"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('pragmate-ui@1.0.6/swiper');
      ims = new Map();
      /***********************************
