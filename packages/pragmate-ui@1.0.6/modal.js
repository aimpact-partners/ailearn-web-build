System.register(["@beyond-js/kernel@0.1.12/bundle", "react@18.3.1", "pragmate-ui@1.0.6/components", "pragmate-ui@1.0.6/icons", "pragmate-ui@1.0.6/base", "@beyond-js/kernel@0.1.12/styles"], function (_export, _context) {
  "use strict";
  ...
  return {
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "pragmate-ui@1.0.6/modal"
        },
        "type": "code"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('pragmate-ui@1.0.6/modal');
      ims = new Map();
      /***********************
