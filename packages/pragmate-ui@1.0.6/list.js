System.register(["@beyond-js/kernel@0.1.12/bundle", "react@18.3.1", "framer-motion@10.18.0", "pragmate-ui@1.0.6/base"], function (_export, _context) {
  "use strict";
  ...
  return {
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "pragmate-ui@1.0.6/list"
        },
        "type": "code"
