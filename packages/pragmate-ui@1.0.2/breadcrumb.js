System.register(["@beyond-js/kernel@0.1.12/bundle", "@beyond-js/kernel@0.1.12/styles", "react@18.3.1", "@beyond-js/kernel@0.1.12/routing", "@beyond-js/react-18-widgets@1.1.4/hooks", "uuid@11.1.0", "pragmate-ui@1.0.2/components"], function (_export, _context) {
  "use strict";
  ...
  return {
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "pragmate-ui@1.0.2/breadcrumb"
        },
        "type": "code"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('pragmate-ui@1.0.2/breadcrumb');
      ims = new Map();
      /***********************
