System.register(["@beyond-js/widgets@1.1.2/render", "@beyond-js/kernel@0.1.12/bundle", "@beyond-js/kernel@0.1.12/styles", "@beyond-js/react-18-widgets@1.1.4/base", "pragmate-ui@1.0.2/template/manager", "react@18.3.1", "pragmate-ui@1.0.2/components", "pragmate-ui@1.0.2/theme-switcher", "pragmate-ui@1.0.2/tooltip", "@beyond-js/react-18-widgets@1.1.4/hooks"], function (_export, _context) {
  "use strict";
  ...
  return {
    ...
    }, function (_pragmateUi102TemplateManager) {
      dependency_4 = _pragmateUi102TemplateManager;
    }, function (_react2) {
      dependency_5 = _react2;
    }, function (_pragmateUi102Components) {
      dependency_6 = _pragmateUi102Components;
    }, function (_pragmateUi102ThemeSwitcher) {
      dependency_7 = _pragmateUi102ThemeSwitcher;
    }, function (_pragmateUi102Tooltip) {
      dependency_8 = _pragmateUi102Tooltip;
    ...
    execute: function () {
      ...
      brequire('@beyond-js/kernel/styles').styles.register('pragmate-ui@1.0.2/pui/template/palette');
      ims = new Map();
      /****************************
