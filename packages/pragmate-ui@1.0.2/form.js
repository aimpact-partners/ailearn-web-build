System.register(["@beyond-js/kernel@0.1.12/bundle", "react@18.3.1", "pragmate-ui@1.0.2/base", "pragmate-ui@1.0.2/icons", "@beyond-js/kernel@0.1.12/styles"], function (_export, _context2) {
  "use strict";
  ...
  return {
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "pragmate-ui@1.0.2/form"
        },
        "type": "code",
        "name": "form"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('pragmate-ui@1.0.2/form');
      ims = new Map();
      /********************************
