System.register(["@beyond-js/kernel@0.1.9/bundle", "react@18.2.0", "@beyond-js/reactive@1.1.12/model", "pragmate-ui@1.0.0-beta.6/base", "pragmate-ui@1.0.0-beta.6/icons", "@beyond-js/kernel@0.1.9/styles"], function (_export, _context2) {
  "use strict";
