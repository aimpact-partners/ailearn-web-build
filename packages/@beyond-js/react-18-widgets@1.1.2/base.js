System.register(["@beyond-js/kernel@0.1.9/bundle", "@beyond-js/widgets@1.1.1/controller", "react@18.2.0", "react-dom@18.2.0/client", "@beyond-js/widgets@1.1.1/routing"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      bimport = specifier => {
        const dependencies = new Map([["react", "18.2.0"], ["react-dom", "18.2.0"], ["@beyond-js/widgets", "1.1.0"], ["@beyond-js/kernel", "0.1.9"], ["@types/react", "18.0.26"], ["@types/react-dom", "18.0.10"], ["@beyond-js/react-18-widgets", "1.1.2"], ["@aimpact/ailearn-app", "0.2.17"]]);
