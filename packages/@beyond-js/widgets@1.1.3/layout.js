System.register(["@beyond-js/kernel@0.1.12/bundle", "@beyond-js/widgets@1.1.3/render"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsKernel0112Bundle) {
      ...
      dependency_1 = _beyondJsWidgets113Render;
    }],
    execute: function () {
      bimport = specifier => {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@beyond-js/widgets@1.1.3/layout"
        },
        "type": "ts"
