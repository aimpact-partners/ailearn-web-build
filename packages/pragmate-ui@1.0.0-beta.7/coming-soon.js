System.register(["@beyond-js/widgets@1.1.3/render", "@beyond-js/kernel@0.1.12/bundle", "@beyond-js/kernel@0.1.12/styles", "@beyond-js/react-18-widgets@1.1.4/page", "react@18.3.1"], function (_export, _context) {
  "use strict";
  ...
  return {
    ...
    execute: function () {
      ...
      brequire('@beyond-js/kernel/styles').styles.register('pragmate-ui@1.0.0-beta.7/coming-soon');
      ims = new Map();
      /****************************
