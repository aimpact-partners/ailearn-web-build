System.register(["@beyond-js/widgets@1.1.0/render", "@beyond-js/kernel@0.1.9/bundle", "@beyond-js/kernel@0.1.9/styles", "@beyond-js/react-18-widgets@1.1.1/page", "pragmate-ui@0.0.6/alert", "react@18.2.0", "@aimpact/ailearn-app@0.0.30/components/ui", "pragmate-ui@0.0.6/components", "@aimpact/chat@1.0.1/shared/components", "pragmate-ui@0.0.6/icons", "pragmate-ui@0.0.6/image", "pragmate-ui@0.0.6/tabs"], function (_export, _context) {
  "use strict";
  ...
  return {
    ...
    execute: function () {
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.0.30/ui/components');
      ims = new Map();
      /****************************
