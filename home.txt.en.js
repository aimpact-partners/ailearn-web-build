      ...
      *********************/
      ims.set('./txt', {
        ...
        creator: function (require, exports) {
          exports.txt = {
            "header": "Header title",
            "dividerTitle": "My learning modules",
            "greeting": "¡Hello, %name!",
            "greetingIntro": "Here you will find the learning module that your teacher will share with you in order to work on the curricular objectives. Enter the different classrooms and have fun learning with a personalised tutor.",
            "moduleSubtitleText": "Activities",
            "moduleAccess": "Access",
            "blackList": {
              "title": "Oops, we haven't retrieved recent modules.",
              "description": "Soon, you'll be able to view your most recent activities. Here, you'll find a list of the modules you accessed previously. We're looking forward to it! 🚀"
            }
          };
        }
      });
