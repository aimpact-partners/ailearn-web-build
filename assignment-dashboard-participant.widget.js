System.register(["@beyond-js/widgets@1.1.0/render", "@beyond-js/kernel@0.1.9/bundle", "@beyond-js/kernel@0.1.9/styles", "@beyond-js/react-18-widgets@1.1.2/page", "@aimpact/ailearn-app@0.0.32-beta.13/dashboard-layout.widget", "@aimpact/ailearn-sdk@1.0.0/core", "@beyond-js/reactive@1.1.12/model", "@aimpact/chat-sdk@1.0.0/voice", "@aimpact/chat@1.0.1/wrapper", "react@18.2.0", "pragmate-ui@0.1.1/components", "@beyond-js/react-18-widgets@1.1.2/hooks", "@aimpact/chat@1.0.1/shared/hooks", "@aimpact/ailearn-app@0.0.32-beta.13/components/hooks", "@aimpact/ailearn-app@0.0.32-beta.13/chat/messages", "@aimpact/chat-sdk@1.0.0/widgets/markdown", "@aimpact/ailearn-app@0.0.32-beta.13/components/ui", "@aimpact/media-manager@1.0.0/audio-player", "pragmate-ui@0.1.1/list", "@aimpact/ailearn-app@0.0.32-beta.13/config", "pragmate-ui@0.1.1/alert", "@aimpact/ailearn-app@0.0.32-beta.13/components/icons", "pragmate-ui@0.1.1/icons", "pragmate-ui@0.1.1/tabs", "pragmate-ui@0.1.1/dropdown"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsWidgets110Render) {
    ...
    }, function (_aimpactAilearnApp0032Beta13ChatMessages) {
      dependency_14 = _aimpactAilearnApp0032Beta13ChatMessages;
      ...
      dependency_19 = _aimpactAilearnApp0032Beta13Config;
    }, function (_pragmateUi011Alert) {
      dependency_20 = _pragmateUi011Alert;
    }, function (_aimpactAilearnApp0032Beta13ComponentsIcons) {
      dependency_21 = _aimpactAilearnApp0032Beta13ComponentsIcons;
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.0.32-beta.13/assignment-dashboard-participant",
          "multibundle": true
        },
        "type": "widget"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.0.32-beta.13/assignment-dashboard-participant.widget');
      ims = new Map();
      /****************************
