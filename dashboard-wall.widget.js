System.register(["@beyond-js/widgets@1.1.0/render", "@beyond-js/kernel@0.1.9/bundle", "@beyond-js/kernel@0.1.9/styles", "@beyond-js/react-18-widgets@1.1.2/page", "@aimpact/ailearn-app@0.1.4-test.05/dashboard-layout.widget", "@aimpact/ailearn-sdk@1.0.0/core", "@beyond-js/reactive@1.2.0/model", "@beyond-js/kernel@0.1.9/texts", "react@18.2.0", "pragmate-ui@1.0.0-beta.1/icons", "@aimpact/chat-sdk@1.0.1/session", "@aimpact/chat@1.0.2/shared/icons", "pragmate-ui@1.0.0-beta.1/list", "@aimpact/ailearn-app@0.1.4-test.05/components/ui", "@aimpact/ailearn-app@0.1.4-test.05/components/navbar-header.code", "@aimpact/ailearn-app@0.1.4-test.05/config", "@beyond-js/react-18-widgets@1.1.2/hooks", "react@18.2.0/jsx-runtime"], function (_export, _context2) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsWidgets110Render) {
      ...
      dependency_14 = _aimpactAilearnApp014Test05ComponentsNavbarHeaderCode;
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.1.4-test.05/dashboard-wall",
          "multibundle": true
        },
        "type": "widget"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.1.4-test.05/dashboard-wall.widget');
      ims = new Map();
      /****************************
