System.register(["@beyond-js/kernel@0.1.12/bundle", "@beyond-js/kernel@0.1.12/transversals", "@beyond-js/widgets@1.1.2/render", "@aimpact/ailearn-app@0.4.2/model/wrapper", "@aimpact/chat-sdk@1.5.4/session", "@beyond-js/kernel@0.1.12/routing", "react@18.3.1", "pragmate-ui@1.0.2/icons", "pragmate-ui@1.0.2/image", "@beyond-js/reactive@2.1.0/model", "@aimpact/ailearn-sdk@1.2.0/core", "@aimpact/rvd@0.5.3/config", "@aimpact/chat-sdk@1.5.4/startup", "@aimpact/agents-api@0.4.1/ws-config", "@aimpact/ailearn-sdk@1.2.0/startup"], function (_export, _context) {
  ...
  return {
    ...
    }, function (_aimpactRvd053Config) {
      dependency_11 = _aimpactRvd053Config;
    ...
    execute: function () {
      ...
      **********************************/
      ...
      bundles.push([{
        "module": {
          "vspecifier": "@aimpact/rvd@0.5.3/initialize-app"
        },
        "type": "start"
      }, function (ims, exports) {
        const bimport = specifier => {
