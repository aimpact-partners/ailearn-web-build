System.register(["@beyond-js/kernel@0.1.9/bundle", "@beyond-js/kernel@0.1.9/transversals", "@beyond-js/widgets@1.1.1/render", "@aimpact/ailearn-app@0.3.26/model/wrapper", "@aimpact/chat-sdk@1.4.1/session", "@beyond-js/kernel@0.1.9/routing", "react@18.2.0", "pragmate-ui@1.0.0-beta.7/icons", "pragmate-ui@1.0.0-beta.7/image", "@aimpact/reactive@0.0.1/model", "@aimpact/ailearn-sdk@1.1.0/core", "@aimpact/ailearn-app@0.3.26/config", "@aimpact/chat-sdk@1.4.1/startup", "@aimpact/agents-api@0.4.1/ws-config"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsKernel019Bundle) {
      ...
      dependency_3 = _aimpactAilearnApp0326ModelWrapper;
      ...
      dependency_11 = _aimpactAilearnApp0326Config;
    ...
    execute: function () {
      ...
      *************/
      ...
      widgets.register([{
        ...
        "vspecifier": "@aimpact/ailearn-app@0.3.26/components/ui/page",
        "is": "page",
        ...
        "attrs": ["id"],
        "vspecifier": "@aimpact/ailearn-app@0.3.26/dashboard/wall/widget.widget"
      }, {
        "name": "ailearn-sessions-access",
        "vspecifier": "@aimpact/ailearn-app@0.3.26/sessions/access.widget",
        "is": "page",
        "route": "/sessions/access/${id}",
        "layout": "chat-layout"
      }, {
        "name": "ailearn-assignments-assessment",
        "vspecifier": "@aimpact/ailearn-app@0.3.26/assignments/assessment.widget",
        "is": "page",
        "route": "/assignments/${assignmentId}/assessment/${id}",
        "layout": "main-layout"
      }, {
        "name": "ailearn-character-talk",
        "vspecifier": "@aimpact/ailearn-app@0.3.26/assignments/character-talk.widget",
        "is": "page",
        "route": "/assignments/${assignmentId}/character-talk/${activityId}/chat/${chatId}",
        "layout": "main-layout"
      }, {
        "name": "ailearn-content-theory-page",
        "vspecifier": "@aimpact/ailearn-app@0.3.26/assignments/content-theory.widget",
        "is": "page",
        "route": "/assignments/${assignmentId}/content-theory/${activityId}/chat/${chatId}",
        "layout": "main-layout"
      }, {
        "name": "ailearn-debate-activity-page",
        "vspecifier": "@aimpact/ailearn-app@0.3.26/assignments/debate.widget",
        "is": "page",
        "route": "/assignments/${assignmentId}/debate/${activityId}/chat/${chatId}",
        "layout": "main-layout"
      }, {
        "name": "ailearn-assignments-spoken",
        "vspecifier": "@aimpact/ailearn-app@0.3.26/assignments/spoken.widget",
        "is": "page",
        "route": "/assignments/${assignmentId}/spoken/${id}",
        "layout": "main-layout"
      }, {
        "name": "ailearn-gclassroom-permissions",
        "vspecifier": "@aimpact/ailearn-app@0.3.26/gclassroom-permissions.widget"
      }, {
        ...
        "vspecifier": "@aimpact/ailearn-app@0.3.26/gclassroom/access.widget",
        "is": "page",
        "route": "/gclassroom/access",
        "layout": "chat-layout"
      }, {
        "name": "ailearn-gclassroom-explorer",
        "vspecifier": "@aimpact/ailearn-app@0.3.26/gclassroom-explorer.widget"
      }, {
        ...
        "vspecifier": "@aimpact/ailearn-app@0.3.26/classrooms/list.widget",
        "is": "page",
        "route": "/classrooms/list",
        "layout": "main-layout"
      }, {
        "name": "app-classrooms-management",
        "vspecifier": "@aimpact/ailearn-app@0.3.26/classrooms/management.widget",
        "is": "page",
        ...
        "vspecifier": "@aimpact/ailearn-app@0.3.26/community.widget",
        "is": "page",
        "route": "/community",
        "layout": "main-layout"
      }, {
        "name": "ailearn-modules-list",
        "vspecifier": "@aimpact/ailearn-app@0.3.26/modules/list.widget",
        "is": "page",
        "route": "/modules/list",
        "layout": "main-layout"
      }, {
        "name": "app-module-objective-management",
        "vspecifier": "@aimpact/ailearn-app@0.3.26/modules/draft.widget",
        "is": "page",
        "route": "/modules/management",
        "layout": "main-layout"
      }, {
        "name": "app-organizations-management",
        "vspecifier": "@aimpact/ailearn-app@0.3.26/organizations/management.widget",
        "is": "page",
        "route": "/organizations/management",
        "layout": "main-layout"
      }, {
        "name": "ailearn-organization-join",
        "vspecifier": "@aimpact/ailearn-app@0.3.26/organizations/join.widget",
        "is": "page",
        "route": "/organizations/join",
        "layout": "main-layout"
      }, {
        "name": "ailearn-organizations-list",
        "vspecifier": "@aimpact/ailearn-app@0.3.26/organizations/list.widget",
        "is": "page",
        "route": "/organizations/list",
        "layout": "main-layout"
      }, {
        "name": "app-organizations-view",
        "vspecifier": "@aimpact/ailearn-app@0.3.26/organizations/view.widget",
        "is": "page",
        ...
        "name": "auth-layout",
        "vspecifier": "@aimpact/ailearn-app@0.3.26/auth-layout",
        "is": "layout"
      }, {
        "name": "dashboard-layout",
        "vspecifier": "@aimpact/ailearn-app@0.3.26/dashboard-layout.widget",
        "is": "layout"
      }, {
        "name": "main-layout",
        "vspecifier": "@aimpact/ailearn-app@0.3.26/main-layout.widget",
        "is": "layout"
      }, {
        "name": "ailearn-archive-app",
        "vspecifier": "@aimpact/ailearn-app@0.3.26/archive.widget",
        "is": "page",
        "route": "/archive",
        "layout": "main-layout"
      }, {
        ...
        "vspecifier": "@aimpact/ailearn-app@0.3.26/auth/login/presentation.widget"
      }, {
        "name": "app-not-allowed",
        "vspecifier": "@aimpact/ailearn-app@0.3.26/not-allowed-control.widget"
      }, {
        "name": "app-not-allowed-page",
        "vspecifier": "@aimpact/ailearn-app@0.3.26/not-allowed-page.widget"
      }, {
        "name": "app-missing-control",
        "vspecifier": "@aimpact/ailearn-app@0.3.26/missing.widget"
      }, {
        "name": "app-missing-page",
        "vspecifier": "@aimpact/ailearn-app@0.3.26/missing-page.widget",
        "is": "page",
        "route": "/error-404",
        "layout": "main-layout"
      }, {
        "name": "app-system-error-control",
        "vspecifier": "@aimpact/ailearn-app@0.3.26/system-error-widget.widget"
      }, {
        "name": "app-system-error-page",
        "vspecifier": "@aimpact/ailearn-app@0.3.26/system-error.widget",
        "is": "page",
        "route": "/error-500",
        "layout": "main-layout"
      }, {
        "name": "student-home",
        "vspecifier": "@aimpact/ailearn-app@0.3.26/home.widget",
        "is": "page",
        "route": "/",
        "layout": "main-layout"
      }, {
        "name": "ailearn-identify-page",
        "vspecifier": "@aimpact/ailearn-app@0.3.26/identify.widget",
        "is": "page",
        "route": "/next-steps"
      }, {
        "name": "privacy-page",
        "vspecifier": "@aimpact/ailearn-app@0.3.26/pages/privacy",
        "is": "page",
        "route": "/privacy"
      }, {
        "name": "ailearn-terms-and-conditions-page",
        "vspecifier": "@aimpact/ailearn-app@0.3.26/pages/terms",
        "is": "page",
        "route": "/terms-and-conditions"
      }, {
        "name": "app-template-bottom-bar",
        "vspecifier": "@aimpact/ailearn-app@0.3.26/template/bottom-bar",
        "is": "page",
        "route": "/template/bottom-bar"
      }, {
        "name": "ailearn-ui-components",
        "vspecifier": "@aimpact/ailearn-app@0.3.26/ui/components",
        "is": "page",
        "route": "/ui/components",
        "layout": "main-layout"
      }, {
        "name": "app-updating-page",
        "vspecifier": "@aimpact/ailearn-app@0.3.26/pages/updating.widget",
        "is": "page",
        "route": "/updating"
      }, {
        "name": "app-policies-page",
        "vspecifier": "@aimpact/ailearn-app@0.3.26/pages/age.widget",
        "is": "page",
        "route": "/user-validation"
      }, {
        "name": "ailearn-test-page",
        "vspecifier": "@aimpact/ailearn-app@0.3.26/test",
        "is": "page",
        "route": "/dev/test",
        "layout": "main-layout"
      }, {
        "name": "app-breadcrumb",
        "vspecifier": "@aimpact/ailearn-app@0.3.26/widgets/breadcrumb.widget"
      }]);
      bundles = [];
      /***********************************
      ...
      ***********************************/
      bundles.push([{
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.3.26/routing"
        },
        "type": "start"
      ...
      ******************************************/
      ...
      bundles.push([{
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.3.26/initialize-app"
        },
        "type": "start"
      }, function (ims, exports) {
        const bimport = specifier => {
