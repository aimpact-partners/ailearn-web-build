System.register(["@beyond-js/kernel@0.1.9/bundle", "@beyond-js/kernel@0.1.9/transversals", "@beyond-js/widgets@1.1.0/render", "@aimpact/ailearn-app@0.1.6-dev.10/model/wrapper", "@aimpact/chat-sdk@1.1.0/session", "@beyond-js/kernel@0.1.9/routing", "react@18.2.0", "pragmate-ui@1.0.0-beta.2/icons", "pragmate-ui@1.0.0-beta.2/image", "@beyond-js/reactive@1.2.0/model", "@aimpact/ailearn-app@0.1.6-dev.10/model/gclassroom", "@aimpact/ailearn-sdk@1.0.0/core", "@aimpact/ailearn-app@0.1.6-dev.10/config", "@aimpact/chat-sdk@1.1.0/startup"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsKernel019Bundle) {
    ...
    }, function (_aimpactAilearnApp016Dev10ModelWrapper) {
      dependency_3 = _aimpactAilearnApp016Dev10ModelWrapper;
      ...
      dependency_10 = _aimpactAilearnApp016Dev10ModelGclassroom;
    }, function (_aimpactAilearnSdk100Core) {
      dependency_11 = _aimpactAilearnSdk100Core;
    }, function (_aimpactAilearnApp016Dev10Config) {
      dependency_12 = _aimpactAilearnApp016Dev10Config;
    ...
    execute: function () {
      ...
      *************/
      ...
      widgets.register([{
        ...
        "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.10/assignments/dashboard.widget",
        "is": "page",
        ...
        "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.10/assignment-dashboard-participant.widget",
        "is": "page",
        ...
        "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.10/sessions/access.widget",
        "is": "page",
        "route": "/sessions/access/${id}",
        "layout": "chat-layout"
      }, {
        "name": "ailearn-assignments-all-in-one",
        "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.10/assignments/all-in-one.widget",
        "is": "page",
        "route": "/assignments/${assignmentId}/all-in-one/${id}",
        "layout": "chat-layout"
      }, {
        "name": "ailearn-assignments-assessment",
        "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.10/assignments/assessment.widget",
        "is": "page",
        "route": "/assignments/${assignmentId}/assessment/${id}",
        "layout": "main-layout"
      }, {
        "name": "ailearn-character-talk",
        "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.10/assignments/character-talk.widget",
        "is": "page",
        "route": "/assignments/${assignmentId}/character-talk/${activityId}/chat/${chatId}",
        "layout": "main-layout"
      }, {
        "name": "ailearn-content-theory-page",
        "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.10/assignments/content-theory.widget",
        "is": "page",
        "route": "/assignments/${assignmentId}/content-theory/${activityId}/chat/${chatId}",
        "layout": "main-layout"
      }, {
        "name": "ailearn-debate-activity-page",
        "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.10/assignments/debate.widget",
        "is": "page",
        "route": "/assignments/${assignmentId}/debate/${activityId}/chat/${chatId}",
        "layout": "main-layout"
      }, {
        "name": "ailearn-assignments-spoken",
        "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.10/assignments/spoken.widget",
        "is": "page",
        ...
        "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.10/gclassroom-permissions.widget"
      }, {
        ...
        "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.10/gclassroom/access.widget",
        "is": "page",
        ...
        "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.10/gclassroom-explorer.widget"
      }, {
        ...
        "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.10/classrooms/list.widget",
        "is": "page",
        "route": "/classrooms/list",
        "layout": "main-layout"
      }, {
        "name": "app-classrooms-view",
        "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.10/classrooms/view.widget",
        "is": "page",
        ...
        "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.10/modules/list.widget",
        "is": "page",
        "route": "/modules/list",
        "layout": "main-layout"
      }, {
        ...
        "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.10/organizations/create.widget",
        "is": "page",
        "route": "/organizations/create",
        "layout": "main-layout"
      }, {
        "name": "ailearn-organization-join",
        "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.10/organizations/join.widget",
        "is": "page",
        ...
        "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.10/organizations/view.widget",
        "is": "page",
        ...
        "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.10/layout/empty",
        "is": "layout"
      }, {
        "name": "main-layout",
        "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.10/main-layout.widget",
        "is": "layout"
      }, {
        "name": "app-policies-page",
        "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.10/pages/age.widget",
        "is": "page",
        "route": "/user-validation"
      }, {
        "name": "app-not-allowed",
        "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.10/not-allowed-control.widget"
      }, {
        "name": "app-not-allowed-page",
        "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.10/not-allowed-page.widget"
      }, {
        "name": "app-missing-control",
        "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.10/missing.widget"
      }, {
        "name": "app-missing-page",
        "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.10/missing-page.widget",
        "is": "page",
        "route": "/error-404",
        "layout": "main-layout"
      }, {
        "name": "app-system-error-control",
        "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.10/system-error-widget.widget"
      }, {
        "name": "app-system-error-page",
        "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.10/system-error.widget",
        "is": "page",
        "route": "/error-500",
        "layout": "main-layout"
      }, {
        "name": "student-home",
        "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.10/home.widget",
        "is": "page",
        "route": "/",
        "layout": "main-layout"
      }, {
        "name": "ailearn-identify-page",
        "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.10/identify.widget",
        "is": "page",
        "route": "/next-steps"
      }, {
        "name": "privacy-page",
        "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.10/pages/privacy",
        "is": "page",
        "route": "/privacy"
      }, {
        "name": "ailearn-terms-and-conditions-page",
        "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.10/pages/terms",
        "is": "page",
        "route": "/terms-and-conditions"
      }, {
        "name": "app-template-bottom-bar",
        "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.10/template/bottom-bar",
        "is": "page",
        ...
        "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.10/pages/updating.widget",
        "is": "page",
        "route": "/updating"
      }, {
        "name": "app-test-components",
        "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.10/test/blank",
        "is": "page",
        "route": "/tests/blank"
      }, {
        "name": "app-test-web-component",
        "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.10/test/web-component"
      }, {
        "name": "app-breadcrumb",
        "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.10/widgets/breadcrumb.widget"
      }]);
      bundles = [];
      /***********************************
      ...
      ***********************************/
      bundles.push([{
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.10/routing"
        },
        "type": "start"
      ...
      ******************************************/
      ...
      bundles.push([{
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.10/initialize-app"
        },
        "type": "start"
      }, function (ims, exports) {
        const bimport = specifier => {
