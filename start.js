System.register(["@beyond-js/kernel@0.1.9/bundle", "@beyond-js/kernel@0.1.9/transversals", "@beyond-js/widgets@1.1.0/render", "@aimpact/ailearn-app@0.1.3-test.08/model/wrapper", "@aimpact/chat-sdk@1.0.1/session", "@beyond-js/kernel@0.1.9/routing", "react@18.2.0", "pragmate-ui@1.0.0-beta.1/icons", "pragmate-ui@1.0.0-beta.1/image", "@beyond-js/reactive@1.2.0/model", "@aimpact/ailearn-app@0.1.3-test.08/model/gclassroom", "@aimpact/ailearn-sdk@1.0.0/core", "@aimpact/ailearn-app@0.1.3-test.08/config", "@aimpact/chat-sdk@1.0.1/startup"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsKernel019Bundle) {
      ...
      dependency_3 = _aimpactAilearnApp013Test08ModelWrapper;
      ...
      dependency_10 = _aimpactAilearnApp013Test08ModelGclassroom;
    }, function (_aimpactAilearnSdk100Core) {
      dependency_11 = _aimpactAilearnSdk100Core;
    }, function (_aimpactAilearnApp013Test08Config) {
      dependency_12 = _aimpactAilearnApp013Test08Config;
    ...
    execute: function () {
      ...
      *************/
      ...
      widgets.register([{
        ...
        "vspecifier": "@aimpact/ailearn-app@0.1.3-test.08/assignment-dashboard-participant.widget",
        "is": "page",
        "route": "/assignments/${assignmentId}/dashboard/participant/${participantId}",
        "layout": "dashboard-layout"
      }, {
        "name": "dashboard-wall",
        "vspecifier": "@aimpact/ailearn-app@0.1.3-test.08/dashboard-wall.widget",
        "is": "page",
        ...
        "vspecifier": "@aimpact/ailearn-app@0.1.3-test.08/assignments/assessment.widget",
        "is": "page",
        ...
        "vspecifier": "@aimpact/ailearn-app@0.1.3-test.08/assignments/content-theory.widget",
        "is": "page",
        "route": "/assignments/${assignmentId}/content-theory/${activityId}/chat/${chatId}",
        "layout": "main-layout"
      }, {
        "name": "ailearn-debate-activity-page",
        "vspecifier": "@aimpact/ailearn-app@0.1.3-test.08/assignments/debate.widget",
        "is": "page",
        ...
        "vspecifier": "@aimpact/ailearn-app@0.1.3-test.08/assignments/coach/list.widget",
        "is": "page",
        "route": "/assignments/${id}/coach/list",
        "layout": "main-layout"
      }, {
        "name": "ailearn-assignments-student-list",
        "vspecifier": "@aimpact/ailearn-app@0.1.3-test.08/assignments/student/list.widget",
        "is": "page",
        "route": "/assignments/${id}/student/list",
        "layout": "main-layout"
      }, {
        "name": "ailearn-gclassroom-permissions",
        "vspecifier": "@aimpact/ailearn-app@0.1.3-test.08/gclassroom-permissions.widget"
      }, {
        ...
        "vspecifier": "@aimpact/ailearn-app@0.1.3-test.08/gclassroom/access.widget",
        "is": "page",
        ...
        "vspecifier": "@aimpact/ailearn-app@0.1.3-test.08/classrooms/join.widget",
        "is": "page",
        "route": "/classrooms/join",
        "layout": "main-layout"
      }, {
        "name": "ailearn-classroom-list",
        "vspecifier": "@aimpact/ailearn-app@0.1.3-test.08/classrooms/list.widget",
        "is": "page",
        "route": "/classrooms/list",
        "layout": "main-layout"
      }, {
        "name": "app-classrooms-view",
        "vspecifier": "@aimpact/ailearn-app@0.1.3-test.08/classrooms/view.widget",
        "is": "page",
        "route": "/classrooms/view/${id}",
        "layout": "main-layout"
      }, {
        "name": "ailearn-modules-list",
        "vspecifier": "@aimpact/ailearn-app@0.1.3-test.08/modules/list.widget",
        "is": "page",
        "route": "/modules/list",
        "layout": "main-layout"
      }, {
        ...
        "attrs": ["id", "activityId"],
        "vspecifier": "@aimpact/ailearn-app@0.1.3-test.08/modules/management/settings.widget"
      }, {
        ...
        "vspecifier": "@aimpact/ailearn-app@0.1.3-test.08/organizations/create.widget",
        "is": "page",
        "route": "/organizations/create",
        "layout": "main-layout"
      }, {
        "name": "ailearn-organization-join",
        "vspecifier": "@aimpact/ailearn-app@0.1.3-test.08/organizations/join.widget",
        "is": "page",
        "route": "/organizations/join",
        "layout": "main-layout"
      }, {
        "name": "ailearn-organizations-list",
        "vspecifier": "@aimpact/ailearn-app@0.1.3-test.08/organizations/list.widget",
        "is": "page",
        "route": "/organizations/list",
        "layout": "main-layout"
      }, {
        "name": "app-organizations-view",
        "vspecifier": "@aimpact/ailearn-app@0.1.3-test.08/organizations/view.widget",
        "is": "page",
        ...
        "vspecifier": "@aimpact/ailearn-app@0.1.3-test.08/layout/empty",
        "is": "layout"
      }, {
        "name": "main-layout",
        "vspecifier": "@aimpact/ailearn-app@0.1.3-test.08/main-layout.widget",
        "is": "layout"
      }, {
        "name": "app-policies-page",
        "vspecifier": "@aimpact/ailearn-app@0.1.3-test.08/pages/age.widget",
        "is": "page",
        "route": "/user-validation"
      }, {
        "name": "ailearn-community-modules",
        "vspecifier": "@aimpact/ailearn-app@0.1.3-test.08/community.widget",
        "is": "page",
        "route": "/community",
        "layout": "main-layout"
      }, {
        "name": "app-not-allowed",
        "vspecifier": "@aimpact/ailearn-app@0.1.3-test.08/not-allowed-control.widget"
      }, {
        "name": "app-not-allowed-page",
        "vspecifier": "@aimpact/ailearn-app@0.1.3-test.08/not-allowed-page.widget"
      }, {
        "name": "app-missing-control",
        "vspecifier": "@aimpact/ailearn-app@0.1.3-test.08/missing.widget"
      }, {
        "name": "app-missing-page",
        "vspecifier": "@aimpact/ailearn-app@0.1.3-test.08/missing-page.widget",
        "is": "page",
        "route": "/error-404",
        "layout": "main-layout"
      }, {
        "name": "app-system-error-control",
        "vspecifier": "@aimpact/ailearn-app@0.1.3-test.08/system-error-widget.widget"
      }, {
        "name": "app-system-error-page",
        "vspecifier": "@aimpact/ailearn-app@0.1.3-test.08/system-error.widget",
        "is": "page",
        "route": "/error-500",
        "layout": "main-layout"
      }, {
        "name": "student-home",
        "vspecifier": "@aimpact/ailearn-app@0.1.3-test.08/home.widget",
        "is": "page",
        "route": "/",
        "layout": "main-layout"
      }, {
        "name": "ailearn-identify-page",
        "vspecifier": "@aimpact/ailearn-app@0.1.3-test.08/identify.widget",
        "is": "page",
        "route": "/next-steps"
      }, {
        "name": "privacy-page",
        "vspecifier": "@aimpact/ailearn-app@0.1.3-test.08/pages/privacy",
        "is": "page",
        "route": "/privacy"
      }, {
        "name": "ailearn-terms-and-conditions-page",
        "vspecifier": "@aimpact/ailearn-app@0.1.3-test.08/pages/terms",
        "is": "page",
        "route": "/terms-and-conditions"
      }, {
        "name": "app-updating-page",
        "vspecifier": "@aimpact/ailearn-app@0.1.3-test.08/pages/updating.widget",
        "is": "page",
        "route": "/updating"
      }, {
        "name": "app-template-bottom-bar",
        "vspecifier": "@aimpact/ailearn-app@0.1.3-test.08/template/bottom-bar",
        "is": "page",
        ...
        "vspecifier": "@aimpact/ailearn-app@0.1.3-test.08/ui/components",
        "is": "page",
        "route": "/ui/components",
        "layout": "chat-layout"
      }, {
        "name": "app-test-components",
        "vspecifier": "@aimpact/ailearn-app@0.1.3-test.08/test/blank",
        "is": "page",
        "route": "/tests/blank"
      }, {
        "name": "app-test-web-component",
        "vspecifier": "@aimpact/ailearn-app@0.1.3-test.08/test/web-component"
      }]);
      bundles = [];
      /***********************************
      ...
      ***********************************/
      bundles.push([{
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.1.3-test.08/routing"
        },
        "type": "start"
        ...
        ims.set('./handlers/roles', {
          ...
          creator: function (require, exports) {
            ...
            async function checkRoles(uri, router, next) {
              ...
              if (_session.sessionWrapper.user?.roles.length) return {
                pathname: '/'
              };
      ...
      ******************************************/
      ...
      bundles.push([{
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.1.3-test.08/initialize-app"
        },
        "type": "start"
      }, function (ims, exports) {
        const bimport = specifier => {
