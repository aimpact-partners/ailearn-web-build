          ...
          exports.txt = {
            ...
            "requested": {
              "teacher": {
                ...
                "description": "Te hemos asignado <strong>{totalGenerative} créditos generativos</strong> para crear 5 módulos con IA y <strong>{totalInteraction} créditos interactivos</strong> para la interacción con IA de tus alumnos."
              },
              "teacherInstitution": {
              ...
              "institution": {
                ...
                "description": "Te hemos asignado a tu período de prueba {totalGenerative} créditos para crear 20 módulos con IA y {totalInteraction} créditos para la interacción con IA de los alumnos.",
                "start": "Comenzar"
              }
            },
            "cards": {
