System.register(["@beyond-js/widgets@1.1.1/render", "@beyond-js/kernel@0.1.9/bundle", "@beyond-js/react-18-widgets@1.1.3/base", "@beyond-js/reactive@1.1.12/model", "react@18.2.0", "@beyond-js/react-18-widgets@1.1.3/hooks", "@beyond-js/kernel@0.1.9/styles"], function (_export, _context) {
  "use strict";
  ...
  return {
    ...
    execute: function () {
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.3.24/auth-layout');
      ims = new Map();
      /****************************
