System.register(["@beyond-js/widgets@1.1.3/render", "@beyond-js/kernel@0.1.12/bundle", "@beyond-js/react-18-widgets@1.1.4/base", "@beyond-js/reactive@1.2.0-beta.01/model", "react@18.3.1", "pragmate-ui@1.0.0-beta.7/image", "pragmate-ui@1.0.0-beta.7/components", "@beyond-js/react-18-widgets@1.1.4/hooks"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsWidgets113Render) {
      ...
      dependency_3 = _beyondJsReactive120Beta01Model;
    }, function (_react2) {
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.3.32/auth/login/presentation",
          "multibundle": true
        },
        "type": "widget"
