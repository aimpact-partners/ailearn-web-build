System.register(["@beyond-js/widgets@1.1.1/render", "@beyond-js/kernel@0.1.9/bundle", "@beyond-js/kernel@0.1.9/styles", "@beyond-js/react-18-widgets@1.1.3/base", "react@18.2.0", "@aimpact/ailearn-app@0.3.24/components/ui", "pragmate-ui@1.0.0-beta.7/image", "@beyond-js/react-18-widgets@1.1.3/hooks"], function (_export, _context) {
  "use strict";
  ...
  return {
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.3.24/not-allowed-control",
          "multibundle": true
        },
        "type": "widget"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.3.24/not-allowed-control.widget');
      ims = new Map();
      /****************************
