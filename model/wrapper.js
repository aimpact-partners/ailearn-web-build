System.register(["@beyond-js/kernel@0.1.12/bundle", "@aimpact/reactive@0.0.1/model"], function (_export, _context) {
  "use strict";
  ...
  return {
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.3.32/model/wrapper"
        },
        "type": "ts"
