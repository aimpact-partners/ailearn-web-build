System.register(["@beyond-js/kernel@0.1.9/bundle", "@beyond-js/reactive@1.2.0/model", "@aimpact/ailearn-app@0.1.6-dev.16/model/wrapper", "@aimpact/http-suite@0.0.1/api", "@beyond-js/kernel@0.1.9/core", "@aimpact/ailearn-app@0.1.6-dev.16/config", "dayjs@1.11.10", "@aimpact/chat-sdk@1.1.0/session"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsKernel019Bundle) {
      ...
      dependency_2 = _aimpactAilearnApp016Dev16ModelWrapper;
    }, function (_aimpactHttpSuite001Api) {
      dependency_3 = _aimpactHttpSuite001Api;
    }, function (_beyondJsKernel019Core) {
      dependency_4 = _beyondJsKernel019Core;
    }, function (_aimpactAilearnApp016Dev16Config) {
      dependency_5 = _aimpactAilearnApp016Dev16Config;
    }, function (_dayjs2) {
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.16/model/gclassroom"
        },
        "type": "ts"
