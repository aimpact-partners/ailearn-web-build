System.register(["@beyond-js/kernel@0.1.9/bundle", "@beyond-js/reactive@1.1.9/model", "@aimpact/ailearn-app@0.0.24/model/wrapper", "@bgroup/http-suite@1.0.3/api", "@beyond-js/kernel@0.1.9/core", "@aimpact/ailearn-app@0.0.24/config", "dayjs@1.11.10", "@aimpact/chat-sdk@1.0.0/session"], function (_export, _context) {
  "use strict";
