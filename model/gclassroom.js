System.register(["@beyond-js/kernel@0.1.9/bundle", "@beyond-js/reactive@1.1.12/model", "@aimpact/ailearn-app@0.0.43/model/wrapper", "@aimpact/http-suite@1.0.3/api", "@beyond-js/kernel@0.1.9/core", "@aimpact/ailearn-app@0.0.43/config", "dayjs@1.11.10", "@aimpact/chat-sdk@1.0.0/session"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsKernel019Bundle) {
      ...
      dependency_2 = _aimpactAilearnApp0043ModelWrapper;
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.0.43/model/gclassroom"
        },
        "type": "ts"
