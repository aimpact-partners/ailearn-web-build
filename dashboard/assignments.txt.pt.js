        ...
        creator: function (require, exports) {
          exports.txt = {
            "activities": {
              ...
              "progres": "Progresso dos objetivos da conversa",
              ...
              "spoken": {
                "audio": "Avaliação oral gravada",
                "feedback": "Feedback"
              },
              "multipleChoice": {
                "participation": {
                  "title": "Participação",
                  "detail": "O estudante respondeu <span class='number-data'>{correct}</span> corretas de <span class='number-data'>{total}</span> perguntas."
                }
              },
              "types": {
