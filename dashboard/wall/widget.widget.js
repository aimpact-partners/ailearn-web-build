System.register(["@beyond-js/widgets@1.1.1/render", "@beyond-js/kernel@0.1.9/bundle", "@beyond-js/kernel@0.1.9/styles", "@beyond-js/react-18-widgets@1.1.3/base", "@aimpact/ailearn-app@0.3.26/dashboard-layout.widget", "@aimpact/ailearn-sdk@1.1.0/core", "@aimpact/ailearn-sdk@1.1.0/tracking", "@aimpact/reactive@0.0.1/model", "@beyond-js/kernel@0.1.9/texts", "react@18.2.0", "@aimpact/chat-sdk@1.4.1/session", "@aimpact/ailearn-app@0.3.26/components/icons", "pragmate-ui@1.0.0-beta.7/list", "pragmate-ui@1.0.0-beta.7/icons", "@aimpact/chat-sdk@1.4.1/widgets/markdown", "@aimpact/ailearn-app@0.3.26/components/ui", "@aimpact/ailearn-app@0.3.26/components/navbar-header.code", "@aimpact/ailearn-app@0.3.26/config", "@beyond-js/react-18-widgets@1.1.3/hooks", "react@18.2.0/jsx-runtime"], function (_export, _context2) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsWidgets111Render) {
      ...
      dependency_4 = _aimpactAilearnApp0326DashboardLayoutWidget;
      ...
      dependency_11 = _aimpactAilearnApp0326ComponentsIcons;
      ...
      dependency_15 = _aimpactAilearnApp0326ComponentsUi;
    }, function (_aimpactAilearnApp0326ComponentsNavbarHeaderCode) {
      dependency_16 = _aimpactAilearnApp0326ComponentsNavbarHeaderCode;
    }, function (_aimpactAilearnApp0326Config) {
      dependency_17 = _aimpactAilearnApp0326Config;
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.3.26/dashboard/wall/widget",
          "multibundle": true
        },
        "type": "widget"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.3.26/dashboard/wall/widget.widget');
      ims = new Map();
      /****************************
