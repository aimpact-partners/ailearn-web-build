System.register(["@beyond-js/widgets@1.1.1/render", "@beyond-js/kernel@0.1.9/bundle", "@beyond-js/kernel@0.1.9/styles", "@beyond-js/react-18-widgets@1.1.2/base", "@aimpact/ailearn-app@0.2.15/dashboard-layout.widget", "@aimpact/ailearn-sdk@1.0.0/core", "@beyond-js/reactive@1.1.12/model", "@beyond-js/kernel@0.1.9/texts", "react@18.2.0", "@aimpact/chat-sdk@1.3.0/session", "@aimpact/ailearn-app@0.2.15/components/icons", "pragmate-ui@1.0.0-beta.7/list", "pragmate-ui@1.0.0-beta.7/icons", "@aimpact/ailearn-app@0.2.15/components/ui", "@aimpact/ailearn-app@0.2.15/components/navbar-header.code", "@aimpact/ailearn-app@0.2.15/config", "@beyond-js/react-18-widgets@1.1.2/hooks", "react@18.2.0/jsx-runtime"], function (_export, _context2) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsWidgets111Render) {
      ...
      dependency_13 = _aimpactAilearnApp0215ComponentsUi;
    }, function (_aimpactAilearnApp0215ComponentsNavbarHeaderCode) {
      dependency_14 = _aimpactAilearnApp0215ComponentsNavbarHeaderCode;
    }, function (_aimpactAilearnApp0215Config) {
      dependency_15 = _aimpactAilearnApp0215Config;
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.2.15/dashboard/wall/widget",
          "multibundle": true
        },
        "type": "widget"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.2.15/dashboard/wall/widget.widget');
      ims = new Map();
      /****************************
