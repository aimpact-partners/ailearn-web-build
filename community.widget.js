System.register(["@beyond-js/widgets@1.1.0/render", "@beyond-js/kernel@0.1.9/bundle", "@beyond-js/kernel@0.1.9/styles", "@beyond-js/react-18-widgets@1.1.2/page", "@aimpact/ailearn-app@0.2.12/main-layout.widget", "@beyond-js/reactive@1.1.12/model", "@aimpact/ailearn-sdk@1.0.0/learning-modules", "@beyond-js/kernel@0.1.9/texts", "react@18.2.0", "pragmate-ui@1.0.0-beta.7/components", "@aimpact/ailearn-app@0.2.12/components/ui", "@beyond-js/react-18-widgets@1.1.2/hooks", "@aimpact/ailearn-app@0.2.12/components/icons", "@aimpact/ailearn-app@0.2.12/components/module-card", "@aimpact/ailearn-app@0.2.12/modules/owner-assign.code", "pragmate-ui@1.0.0-beta.7/list", "pragmate-ui@1.0.0-beta.7/empty"], function (_export, _context2) {
  ...
  return {
    setters: [function (_beyondJsWidgets110Render) {
      ...
      dependency_12 = _aimpactAilearnApp0212ComponentsIcons;
    }, function (_aimpactAilearnApp0212ComponentsModuleCard) {
      dependency_13 = _aimpactAilearnApp0212ComponentsModuleCard;
    }, function (_aimpactAilearnApp0212ModulesOwnerAssignCode) {
      dependency_14 = _aimpactAilearnApp0212ModulesOwnerAssignCode;
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.2.12/community",
          "multibundle": true
        },
        "type": "widget"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.2.12/community.widget');
      ims = new Map();
      /****************************
