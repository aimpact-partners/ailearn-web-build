System.register(["@beyond-js/widgets@1.1.1/render", "@beyond-js/kernel@0.1.9/bundle", "@beyond-js/kernel@0.1.9/styles", "@beyond-js/react-18-widgets@1.1.3/page", "@aimpact/ailearn-sdk@1.1.0/core", "@aimpact/reactive@0.0.1/model", "@aimpact/chat-sdk@1.4.1/session", "@aimpact/ailearn-app@0.3.20/model/gclassroom", "react@18.2.0", "@beyond-js/react-18-widgets@1.1.3/hooks", "@aimpact/ailearn-app@0.3.20/components/ui", "pragmate-ui@1.0.0-beta.7/components", "@beyond-js/kernel@0.1.9/routing"], function (_export, _context2) {
  "use strict";
  ...
  return {
    ...
    }, function (_aimpactAilearnApp0320ModelGclassroom) {
      dependency_7 = _aimpactAilearnApp0320ModelGclassroom;
    }, function (_react2) {
      dependency_8 = _react2;
    }, function (_beyondJsReact18Widgets113Hooks) {
      dependency_9 = _beyondJsReact18Widgets113Hooks;
    }, function (_aimpactAilearnApp0320ComponentsUi) {
      dependency_10 = _aimpactAilearnApp0320ComponentsUi;
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.3.20/sessions/access",
          "multibundle": true
        },
        "type": "widget"
      }, _context2.meta.url).package();
      ;
      __pkg.dependencies.update([['@beyond-js/widgets/render', dependency_0], ['@beyond-js/kernel/styles', dependency_2], ['@beyond-js/react-18-widgets/page', dependency_3], ['@aimpact/ailearn-sdk/core', dependency_4], ['@aimpact/reactive/model', dependency_5], ['@aimpact/chat-sdk/session', dependency_6], ['@aimpact/ailearn-app/model/gclassroom', dependency_7], ['react', dependency_8], ['@beyond-js/react-18-widgets/hooks', dependency_9], ['@aimpact/ailearn-app/components/ui', dependency_10], ['pragmate-ui/components', dependency_11], ['@beyond-js/kernel/routing', dependency_12]]);
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.3.20/sessions/access.widget');
      ims = new Map();
      /****************************
