System.register(["@beyond-js/widgets@1.1.1/render", "@beyond-js/kernel@0.1.9/bundle", "@beyond-js/kernel@0.1.9/styles", "@beyond-js/react-18-widgets@1.1.3/page", "@aimpact/ailearn-sdk@1.1.0/core", "@aimpact/reactive@0.0.1/model", "@aimpact/chat-sdk@1.4.1/session", "@aimpact/ailearn-app@0.3.26/model/gclassroom", "react@18.2.0", "@beyond-js/react-18-widgets@1.1.3/hooks", "@aimpact/ailearn-app@0.3.26/components/ui", "pragmate-ui@1.0.0-beta.7/components", "@beyond-js/kernel@0.1.9/routing"], function (_export, _context2) {
  "use strict";
  ...
  return {
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.3.26/sessions/access",
          "multibundle": true
        },
        "type": "widget"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.3.26/sessions/access.widget');
      ims = new Map();
      /****************************
