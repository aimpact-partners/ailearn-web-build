      ...
      *********************/
      ims.set('./txt', {
        ...
        creator: function (require, exports) {
          exports.txt = {
            "welcome": "Bem-vindo ao AI-Learn",
            "shared": "foi compartilhado com você.",
            "action": "Iniciar a aula",
            "save": "Salve a aula e comece a aprender.",
            "accessed": "Acesse os chats da sua aula e continue aprendendo",
            "empty": {
              "welcome": "Ops!",
              "info": "Não foi possível encontrar a aula.",
              "action": "Por favor, reveja o link."
            }
          };
        }
      });
