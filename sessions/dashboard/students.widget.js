System.register(["@beyond-js/widgets@0.1.5/render", "@beyond-js/kernel@0.1.9/bundle", "@beyond-js/kernel@0.1.9/styles", "@beyond-js/react-18-widgets@1.0.1/page", "react@18.2.0", "@beyond-js/reactive@1.1.6/model", "@aimpact/chat@1.0.1/api", "@aimpact/ailearn-app@1.0.0/config", "@aimpact/chat-sdk@1.0.0/session", "pragmate-ui@0.0.36/components", "@beyond-js/react-18-widgets@1.0.1/hooks", "@aimpact/chat@1.0.1/shared/hooks", "@aimpact/ailearn-app@1.0.0/components/charts", "pragmate-ui@0.0.36/icons"], function (_export, _context) {
  ...
  return {
    setters: [function (_beyondJsWidgets015Render) {
      ...
      dependency_13 = _pragmateUi0036Icons;
    }],
    execute: function () {
      bimport = specifier => {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@1.0.0/sessions/dashboard/students",
          "multibundle": true
        },
        "type": "widget"
      ...
      brequire('@beyond-js/widgets/render').widgets.register([{
        ...
        "vspecifier": "@aimpact/ailearn-app@1.0.0/sessions/dashboard/students.widget",
        "is": "page",
        "route": "/sessions/dashboard/students/${id}",
        "layout": "chat-layout"
      }]);
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@1.0.0/sessions/dashboard/students.widget');
      ims = new Map();
      /****************************
