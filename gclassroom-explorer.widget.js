System.register(["@beyond-js/widgets@1.1.3/render", "@beyond-js/kernel@0.1.12/bundle", "@beyond-js/kernel@0.1.12/styles", "@beyond-js/react-18-widgets@1.1.4/base", "@aimpact/ailearn-app@0.3.32/model/gclassroom", "@aimpact/reactive@0.0.1/model", "@aimpact/chat-sdk@1.4.3/core", "dayjs@1.11.13", "react@18.3.1", "pragmate-ui@1.0.0-beta.7/icons", "pragmate-ui@1.0.0-beta.7/components", "@beyond-js/react-18-widgets@1.1.4/hooks", "@aimpact/ailearn-app@0.3.32/model/wrapper", "@beyond-js/kernel@0.1.12/routing"], function (_export, _context2) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsWidgets113Render) {
      ...
      dependency_4 = _aimpactAilearnApp0332ModelGclassroom;
    }, function (_aimpactReactive001Model) {
      dependency_5 = _aimpactReactive001Model;
    }, function (_aimpactChatSdk143Core) {
      dependency_6 = _aimpactChatSdk143Core;
    }, function (_dayjs2) {
      ...
      dependency_12 = _aimpactAilearnApp0332ModelWrapper;
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.3.32/gclassroom-explorer",
          "multibundle": true
        },
        "type": "widget"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.3.32/gclassroom-explorer.widget');
      ims = new Map();
      /****************************
