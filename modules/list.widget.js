System.register(["@beyond-js/widgets@1.1.0/render", "@beyond-js/kernel@0.1.9/bundle", "@beyond-js/kernel@0.1.9/styles", "@beyond-js/react-18-widgets@1.1.2/page", "@aimpact/ailearn-app@0.1.3-test.08/main-layout.widget", "@beyond-js/reactive@1.2.0/model", "@aimpact/ailearn-sdk@1.0.0/learning-modules", "@beyond-js/kernel@0.1.9/texts", "@aimpact/ailearn-app@0.1.3-test.08/config", "react@18.2.0", "pragmate-ui@1.0.0-beta.1/components", "@aimpact/ailearn-app@0.1.3-test.08/components/ui", "@beyond-js/react-18-widgets@1.1.2/hooks", "pragmate-ui@1.0.0-beta.1/icons", "pragmate-ui@1.0.0-beta.1/link", "@aimpact/ailearn-app@0.1.3-test.08/components/module-card", "@aimpact/ailearn-app@0.1.3-test.08/modules/assign", "pragmate-ui@1.0.0-beta.1/tabs", "@beyond-js/kernel@0.1.9/routing", "pragmate-ui@1.0.0-beta.1/list", "pragmate-ui@1.0.0-beta.1/empty"], function (_export, _context2) {
  ...
  return {
    setters: [function (_beyondJsWidgets110Render) {
      ...
      dependency_8 = _aimpactAilearnApp013Test08Config;
    }, function (_react2) {
      ...
      dependency_15 = _aimpactAilearnApp013Test08ComponentsModuleCard;
    }, function (_aimpactAilearnApp013Test08ModulesAssign) {
      dependency_16 = _aimpactAilearnApp013Test08ModulesAssign;
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.1.3-test.08/modules/list",
          "multibundle": true
        },
        "type": "widget"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.1.3-test.08/modules/list.widget');
      ims = new Map();
      /****************************
