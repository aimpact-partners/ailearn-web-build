System.register(["@beyond-js/kernel@0.1.9/bundle", "@aimpact/ailearn-app@0.3.26/entities/assignments/activities/base", "@aimpact/ailearn-app@0.3.26/main-layout.widget", "@aimpact/ailearn-app@0.3.26/widgets/breadcrumb.widget", "@aimpact/ailearn-sdk@1.1.0/entities/learning-modules", "@aimpact/ailearn-app@0.3.26/stores/base", "@aimpact/chat-sdk@1.4.1/session", "@beyond-js/kernel@0.1.9/routing"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsKernel019Bundle) {
      ...
      dependency_1 = _aimpactAilearnApp0326EntitiesAssignmentsActivitiesBase;
    }, function (_aimpactAilearnApp0326MainLayoutWidget) {
      dependency_2 = _aimpactAilearnApp0326MainLayoutWidget;
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.3.26/modules/draft/store",
          "multibundle": true
        },
        "type": "code"
