System.register(["@beyond-js/kernel@0.1.12/bundle", "@aimpact/ailearn-app@0.3.32/entities/assignments/activities/base", "@aimpact/ailearn-app@0.3.32/main-layout.widget", "@aimpact/ailearn-app@0.3.32/widgets/breadcrumb.widget", "@aimpact/ailearn-sdk@1.1.0/entities/learning-modules", "@aimpact/ailearn-app@0.3.32/stores/base", "@aimpact/chat-sdk@1.4.4/session", "@beyond-js/kernel@0.1.12/routing", "@aimpact/ailearn-app@0.3.32/assignments/spoken.widget"], function (_export, _context) {
  "use strict";
  ...
  return {
    ...
    }, function (_aimpactAilearnApp0332AssignmentsSpokenWidget) {
      dependency_8 = _aimpactAilearnApp0332AssignmentsSpokenWidget;
    }],
    execute: function () {
      bimport = specifier => {
