System.register(["@beyond-js/widgets@1.1.0/render", "@beyond-js/kernel@0.1.9/bundle", "@beyond-js/kernel@0.1.9/styles", "@beyond-js/react-18-widgets@1.1.2/base", "@aimpact/ailearn-sdk@1.0.0/learning-modules", "@beyond-js/reactive@1.1.12/model", "@aimpact/chat-sdk@1.0.0/session", "@aimpact/ailearn-app@0.0.32-beta.12/coins-layout.widget", "@beyond-js/kernel@0.1.9/texts", "@beyond-js/kernel@0.1.9/routing", "react@18.2.0", "pragmate-ui@0.1.1/empty", "pragmate-ui@0.1.1/components", "pragmate-ui@0.1.1/list", "pragmate-ui@0.1.1/form", "framer-motion@10.18.0", "pragmate-ui@0.1.1/modal", "pragmate-ui@0.1.1/icons", "@aimpact/ailearn-app@0.0.32-beta.12/components/icons", "pragmate-ui@0.1.1/collapsible", "pragmate-ui@0.1.1/toast", "pragmate-ui@0.1.1/chips", "@aimpact/ailearn-app@0.0.32-beta.12/components/ui", "@aimpact/ailearn-app@0.0.32-beta.12/config", "@aimpact/ailearn-app@0.0.32-beta.12/modules/management/activity.code", "pragmate-ui@0.1.1/alert", "@beyond-js/react-18-widgets@1.1.2/hooks", "@aimpact/ailearn-app@0.0.32-beta.12/components/cover-image.code", "@aimpact/chat@1.0.1/shared/hooks"], function (_export, _context3) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsWidgets110Render) {
      ...
      dependency_18 = _aimpactAilearnApp0032Beta12ComponentsIcons;
      ...
      dependency_22 = _aimpactAilearnApp0032Beta12ComponentsUi;
    }, function (_aimpactAilearnApp0032Beta12Config) {
      dependency_23 = _aimpactAilearnApp0032Beta12Config;
    }, function (_aimpactAilearnApp0032Beta12ModulesManagementActivityCode) {
      dependency_24 = _aimpactAilearnApp0032Beta12ModulesManagementActivityCode;
      ...
      dependency_27 = _aimpactAilearnApp0032Beta12ComponentsCoverImageCode;
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.0.32-beta.12/modules/management/settings",
          "multibundle": true
        },
        "type": "widget"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.0.32-beta.12/modules/management/settings.widget');
      ims = new Map();
      /****************************
