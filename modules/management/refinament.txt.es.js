System.register(["@beyond-js/kernel@0.1.9/bundle"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.3.17/modules/management/refinament",
          "multibundle": true
        },
        "type": "txt"
      ...
      ims.set('./txt', {
        ...
        creator: function (require, exports) {
          exports.txt = {
            ...
            "errors": {
              "200": "El objetivo de la actividad es obligatorio",
              "NO_RELATED_ACTIVITY": "La actividad relacionada aún no posee contenido, para utilizarla es necesario generar el contenido previamente",
              "default": "Ha ocurrido un error, vuelva a intentarlo"
            },
            "activity": {
              "title": "Generar la actividad con IA",
              "description": "Vamos a generar la actividad en base al siguiente objetivo"
            },
            "error": "Por favor, añade notas detalladas para la generación",
            "textarea": {
