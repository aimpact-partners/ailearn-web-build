System.register(["@beyond-js/kernel@0.1.9/bundle", "react@18.2.0", "pragmate-ui@1.0.0-beta.2/components", "pragmate-ui@1.0.0-beta.2/list", "pragmate-ui@1.0.0-beta.2/modal", "@aimpact/ailearn-app@0.1.6-dev.16/components/ui", "@beyond-js/react-18-widgets@1.1.2/hooks", "framer-motion@10.18.0", "@aimpact/ailearn-app@0.1.6-dev.16/main-layout.widget", "pragmate-ui@1.0.0-beta.2/form"], function (_export, _context2) {
  ...
  return {
    setters: [function (_beyondJsKernel019Bundle) {
      ...
      dependency_8 = _aimpactAilearnApp016Dev16MainLayoutWidget;
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.1.6-dev.16/modules/management/refinament",
          "multibundle": true
        },
        "type": "code"
