System.register(["@beyond-js/widgets@1.1.1/render", "@beyond-js/kernel@0.1.9/bundle", "@beyond-js/kernel@0.1.9/styles", "@beyond-js/react-18-widgets@1.1.2/page", "@beyond-js/reactive@1.1.12/model", "@aimpact/ailearn-sdk@1.0.0/entities/organizations", "@aimpact/ailearn-app@0.2.16/main-layout.widget", "@beyond-js/kernel@0.1.9/texts", "@aimpact/chat-sdk@1.3.0/session", "@aimpact/ailearn-app@0.2.16/i18n.ts", "react@18.2.0", "framer-motion@10.18.0", "@aimpact/ailearn-app@0.2.16/components/ui", "pragmate-ui@1.0.0-beta.7/image", "pragmate-ui@1.0.0-beta.7/form", "pragmate-ui@1.0.0-beta.7/toast", "pragmate-ui@1.0.0-beta.7/code-verification", "pragmate-ui@1.0.0-beta.7/components", "@beyond-js/kernel@0.1.9/routing", "@aimpact/ailearn-app/start", "@aimpact/ailearn-app@0.2.16/components/navbar-header.code", "@aimpact/ailearn-app@0.2.16/config", "@beyond-js/react-18-widgets@1.1.2/hooks"], function (_export, _context2) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsWidgets111Render) {
      ...
      dependency_9 = _aimpactAilearnApp0216I18nTs;
    }, function (_react2) {
      ...
      dependency_20 = _aimpactAilearnApp0216ComponentsNavbarHeaderCode;
    }, function (_aimpactAilearnApp0216Config) {
      dependency_21 = _aimpactAilearnApp0216Config;
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.2.16/organizations/join",
          "multibundle": true
        },
        "type": "widget"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.2.16/organizations/join.widget');
      ims = new Map();
      /****************************
