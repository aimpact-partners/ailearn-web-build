System.register(["@beyond-js/widgets@1.1.3/render", "@beyond-js/kernel@0.1.12/bundle", "@beyond-js/kernel@0.1.12/styles", "@beyond-js/react-18-widgets@1.1.4/page", "@aimpact/reactive@0.0.1/model", "@aimpact/ailearn-sdk@1.1.0/entities/organizations", "@aimpact/ailearn-app@0.3.32/main-layout.widget", "@beyond-js/kernel@0.1.12/texts", "@aimpact/chat-sdk@1.4.3/session", "@aimpact/ailearn-app@0.3.32/i18n.ts", "react@18.3.1", "framer-motion@10.18.0", "@aimpact/ailearn-app@0.3.32/components/ui", "pragmate-ui@1.0.0-beta.7/image", "pragmate-ui@1.0.0-beta.7/form", "pragmate-ui@1.0.0-beta.7/toast", "pragmate-ui@1.0.0-beta.7/code-verification", "pragmate-ui@1.0.0-beta.7/components", "@beyond-js/kernel@0.1.12/routing", "@aimpact/ailearn-app/start", "@aimpact/ailearn-app@0.3.32/components/navbar-header.code", "@aimpact/ailearn-app@0.3.32/config", "@beyond-js/react-18-widgets@1.1.4/hooks"], function (_export, _context2) {
  "use strict";
  ...
  return {
    setters: [function (_beyondJsWidgets113Render) {
      ...
      dependency_8 = _aimpactChatSdk143Session;
      ...
      dependency_20 = _aimpactAilearnApp0332ComponentsNavbarHeaderCode;
    }, function (_aimpactAilearnApp0332Config) {
      dependency_21 = _aimpactAilearnApp0332Config;
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.3.32/organizations/join",
          "multibundle": true
        },
        "type": "widget"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.3.32/organizations/join.widget');
      ims = new Map();
      /****************************
