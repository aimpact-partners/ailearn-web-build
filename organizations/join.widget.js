System.register(["@beyond-js/widgets@1.1.0/render", "@beyond-js/kernel@0.1.9/bundle", "@beyond-js/kernel@0.1.9/styles", "@beyond-js/react-18-widgets@1.1.2/page", "@beyond-js/reactive@1.1.12/model", "@aimpact/ailearn-sdk@1.0.0/core", "@aimpact/ailearn-app@0.0.46.dev-14/main-layout.widget", "@beyond-js/kernel@0.1.9/texts", "react@18.2.0", "framer-motion@10.18.0", "@aimpact/ailearn-app@0.0.46.dev-14/components/ui", "pragmate-ui@0.1.1/image", "pragmate-ui@0.1.1/form", "pragmate-ui@0.1.1/toast", "pragmate-ui@0.1.1/code-verification", "pragmate-ui@0.1.1/components", "@beyond-js/react-18-widgets@1.1.2/hooks", "@beyond-js/kernel@0.1.9/routing", "@aimpact/ailearn-app@0.0.46.dev-14/components/navbar-header.code", "@aimpact/ailearn-app@0.0.46.dev-14/config"], function (_export, _context2) {
  ...
  return {
    setters: [function (_beyondJsWidgets110Render) {
      ...
      dependency_18 = _aimpactAilearnApp0046Dev14ComponentsNavbarHeaderCode;
    }, function (_aimpactAilearnApp0046Dev14Config) {
      dependency_19 = _aimpactAilearnApp0046Dev14Config;
    }],
    execute: function () {
      bimport = specifier => {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.0.46.dev-14/organizations/join",
          "multibundle": true
        },
        "type": "widget"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.0.46.dev-14/organizations/join.widget');
      ims = new Map();
      /****************************
