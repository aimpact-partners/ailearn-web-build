System.register(["@beyond-js/widgets@1.1.1/render", "@beyond-js/kernel@0.1.9/bundle", "@beyond-js/kernel@0.1.9/styles", "@beyond-js/react-18-widgets@1.1.3/page", "@aimpact/ailearn-app@0.3.24/main-layout.widget", "@aimpact/ailearn-sdk@1.1.0/entities/organizations", "@aimpact/reactive@0.0.1/model", "@beyond-js/kernel@0.1.9/texts", "@beyond-js/widgets@1.1.1/controller", "react@18.2.0", "pragmate-ui@1.0.0-beta.7/components", "@aimpact/ailearn-app@0.3.24/components/ui", "@aimpact/ailearn-app@0.3.24/components/hooks", "pragmate-ui@1.0.0-beta.7/icons", "@aimpact/ailearn-app@0.3.24/components/icons", "pragmate-ui@1.0.0-beta.7/dropdown", "@beyond-js/react-18-widgets@1.1.3/hooks", "pragmate-ui@1.0.0-beta.7/modal", "pragmate-ui@1.0.0-beta.7/base", "@aimpact/ailearn-app@0.3.24/components/module-card", "pragmate-ui@1.0.0-beta.7/toast", "pragmate-ui@1.0.0-beta.7/list"], function (_export, _context2) {
  ...
  return {
    setters: [function (_beyondJsWidgets111Render) {
      ...
      dependency_12 = _aimpactAilearnApp0324ComponentsHooks;
    }, function (_pragmateUi100Beta7Icons) {
      dependency_13 = _pragmateUi100Beta7Icons;
    }, function (_aimpactAilearnApp0324ComponentsIcons) {
      dependency_14 = _aimpactAilearnApp0324ComponentsIcons;
      ...
      dependency_19 = _aimpactAilearnApp0324ComponentsModuleCard;
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.3.24/organizations/list",
          "multibundle": true
        },
        "type": "widget"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.3.24/organizations/list.widget');
      ims = new Map();
      /****************************
