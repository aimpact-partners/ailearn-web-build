      ...
      ims.set('./txt', {
        ...
        creator: function (require, exports) {
          exports.txt = {
            ...
            "title": "Únete a una Institución",
            "describe": "Únete a una institución para acceder al contenido y participar en actividades educativas.",
            "form": {
              "title": "Código de Institución",
              "subtitle": "Ingresa el código  proporcionado por el administrador de la institución",
              "placeholder": "Código de institución"
            },
            "info": {
              "title": "Cómo unirse con un código válido",
              "help": "Si tienes problemas para unirte, consulta con el administrador de la institución."
            },
            "member": {
              "title": "Ya eres miembro de la institución",
              "action": "Ir a la institución"
            },
            "ready": {
              "title": "Solicitud enviada",
              "description": "Ahora debes esperar a que el administrador apruebe tu solicitud de acceso al aula. Recibirás un correo electrónico cuando se haya aprobado"
            },
            "messages": {
              "success": "¡Te has unido a la institución!",
