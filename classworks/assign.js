System.register(["@beyond-js/kernel@0.1.9/bundle", "react@18.2.0", "pragmate-ui@0.0.3/components", "pragmate-ui@0.0.3/modal", "@aimpact/chat@1.0.1/shared/components", "@aimpact/ailearn-app@0.0.24/config", "pragmate-ui@0.0.3/toast", "@beyond-js/kernel@0.1.9/styles"], function (_export, _context) {
  "use strict";
  ...
  return {
    ...
    execute: function () {
      ...
      __pkg = new __Bundle({
        "module": {
          "vspecifier": "@aimpact/ailearn-app@0.0.23/classworks/assign"
        },
        "type": "code"
      ...
      brequire('@beyond-js/kernel/styles').styles.register('@aimpact/ailearn-app@0.0.23/classworks/assign');
      ims = new Map();
      /****************************
