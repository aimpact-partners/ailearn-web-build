          ...
          exports.txt = {
            ...
            "institution": {
              "form": {
                ...
                "description": "Request access to a free trial by completing the form. Once submitted, we will review your request. Remember to check your email, where we will inform you about the approval of your request and assign you the necessary credits so your educational community can experience the assistance of Artificial Intelligence in the classroom.",
                "fields": {
                  "name": {
            ...
            "requested": {
              "teacher": {
                ...
                "description": "Remember to check your email {email}, where we will inform you about the approval of your request and the assignment of credits so you can experience the assistance of Artificial Intelligence in your teaching work."
              },
              "teacherInstitution": {
            ...
            "teacher": {
              "form": {
                "title": "Request a free trial for teachers and start exploring educational transformation",
                "description": "Request access to a free trial by completing the form. Once submitted, we will review your request. Remember to check your email, where we will inform you about the approval of your request and assign you the necessary credits so you can experience the assistance of Artificial Intelligence in your teaching work.",
                "fields": {
                  "role": {
                    "label": "Cargo",
                    "errorMessage": "Required field"
              ...
              "institution": {
                "intro": {
                  ...
                  "options": {
                    "yes": {
                      "label": "Yes",
                      "description": "My institution already works with RVD.AI Rivadavia and I want to join its educational space."
                    },
                    "no": {
                      "label": "No",
                      "description": "My institution does not work with RVD.AI Rivadavia. I want to request a free trial for individual use as a teacher."
                    }
                  }
                },
                "form": {
                  "title": "Start the educational transformation",
                  "description": "You are about to join your institution's educational space in RVD.AI Rivadavia. Enter the identification code you received in your email.",
                  "form": {
                    "legend": {
