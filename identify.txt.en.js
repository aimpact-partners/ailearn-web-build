          ...
          exports.txt = {
            ...
            "requested": {
              "teacher": {
                ...
                "description": "We have assigned you <strong>{totalGenerative} generative credits</strong> to create 5 modules with AI and <strong>{totalInteraction} interactive credits</strong> for AI interaction with your students."
              },
              "teacherInstitution": {
              ...
              "institution": {
                ...
                "description": "We have assigned you {totalGenerative} credits for your trial period to create 20 modules with AI and {totalInteraction} credits for AI interaction with students.",
                "start": "Start"
              }
            },
            "cards": {
