      ...
      *********************/
      ims.set('./txt', {
        ...
        creator: function (require, exports) {
          exports.txt = {
            "preTitle": "Vincule sua conta com",
            "title": "Google Classroom",
            "subtitle": "A nova maneira de ensinar e aprender com Inteligência Artificial",
            "instructions": "Precisamos vincular sua conta ao Google Classroom para que possamos atribuir os trabalhos de curso que você gerar às suas salas de aula. Clique em 'Link Now' para continuar.",
            "error": "Algo deu errado! Por favor, entre em contato com o administrador",
            "action": "Vincular agora",
            "theme": "Modo %them",
            "ERROR_GETTING_URL": "Erro ao obter a URL do Classroom"
          };
        }
      });
